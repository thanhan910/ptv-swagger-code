...
class V3Departure(object):
    ...
    def __init__(self, stop_id=None, route_id=None, run_id=None, run_ref=None, direction_id=None, disruption_ids=None, scheduled_departure_utc=None, estimated_departure_utc=None, at_platform=None, platform_number=None, flags=None, departure_sequence=None):  # noqa: E501
