...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3DisruptionStop :  IEquatable<V3DisruptionStop>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3DisruptionStop" /> class.
        /// </summary>
        /// <param name="stopId">stopId.</param>
        /// <param name="stopName">stopName.</param>
        public V3DisruptionStop(int? stopId = default(int?), string stopName = default(string))
        {
            this.StopId = stopId;
        ...
        {
            return this.Equals(input as V3DisruptionStop);
        }

        /// <summary>
        /// Returns true if V3DisruptionStop instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DisruptionStop to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DisruptionStop input)
        {
            if (input == null)
                return false;
