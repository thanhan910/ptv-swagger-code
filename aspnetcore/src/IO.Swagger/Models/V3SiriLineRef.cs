...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SiriLineRef : IEquatable<V3SiriLineRef>
    { 
        /// <summary>
        /// Siri LineRef
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3SiriLineRef)obj);
        }

        /// <summary>
        /// Returns true if V3SiriLineRef instances are equal
        /// </summary>
        /// <param name="other">Instance of V3SiriLineRef to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SiriLineRef other)
        {
        ...
        public static bool operator ==(V3SiriLineRef left, V3SiriLineRef right)
        {
