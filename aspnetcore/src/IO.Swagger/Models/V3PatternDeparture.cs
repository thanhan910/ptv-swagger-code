...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3PatternDeparture : IEquatable<V3PatternDeparture>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3PatternDeparture)obj);
        }

        /// <summary>
        /// Returns true if V3PatternDeparture instances are equal
        /// </summary>
        /// <param name="other">Instance of V3PatternDeparture to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3PatternDeparture other)
        {
            ...
            return 
                (
                    ...
                    SkippedStops != null &&
                    SkippedStops.SequenceEqual(other.SkippedStops)
                ) && 
                (
                    StopId == other.StopId ||
                    StopId != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (SkippedStops != null)
                    hashCode = hashCode * 59 + SkippedStops.GetHashCode();
                    if (StopId != null)
        ...
        public static bool operator ==(V3PatternDeparture left, V3PatternDeparture right)
        {
