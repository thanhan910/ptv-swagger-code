...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3DirectionWithDescription : IEquatable<V3DirectionWithDescription>
    { 
        /// <summary>
        /// Gets or Sets RouteDirectionDescription
        /// </summary>

        [DataMember(Name="route_direction_description")]
        ...
        [DataMember(Name="direction_name")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3DirectionWithDescription)obj);
        }

        /// <summary>
        /// Returns true if V3DirectionWithDescription instances are equal
        /// </summary>
        /// <param name="other">Instance of V3DirectionWithDescription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DirectionWithDescription other)
        {
            ...
            return 
                (
                    ...
                    RouteDirectionDescription.Equals(other.RouteDirectionDescription)
                ) && 
                (
                ...
                (
                    ...
                    DirectionName != null &&
                    DirectionName.Equals(other.DirectionName)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + RouteDirectionDescription.GetHashCode();
                    if (DirectionId != null)
                    hashCode = hashCode * 59 + DirectionId.GetHashCode();
                    if (DirectionName != null)
                    hashCode = hashCode * 59 + DirectionName.GetHashCode();
                    if (RouteId != null)
        ...
        public static bool operator ==(V3DirectionWithDescription left, V3DirectionWithDescription right)
        {
