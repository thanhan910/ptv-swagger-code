...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3StopAmenityDetails)obj);
        }
        ...
        public bool Equals(V3StopAmenityDetails other)
        {
            ...
            return 
                ...
                (
                    ...
                    TaxiRank != null &&
                    TaxiRank.Equals(other.TaxiRank)
                ) && 
                (
                    CarParking == other.CarParking ||
                    CarParking != null &&
                    CarParking.Equals(other.CarParking)
                ) && 
                (
                    Cctv == other.Cctv ||
                    Cctv != null &&
                    Cctv.Equals(other.Cctv)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (TaxiRank != null)
                    hashCode = hashCode * 59 + TaxiRank.GetHashCode();
                    if (CarParking != null)
                    hashCode = hashCode * 59 + CarParking.GetHashCode();
                    if (Cctv != null)
                    hashCode = hashCode * 59 + Cctv.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(V3StopAmenityDetails left, V3StopAmenityDetails right)
        {
