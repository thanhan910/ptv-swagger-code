...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3BulkDeparturesRequest : IEquatable<V3BulkDeparturesRequest>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3BulkDeparturesRequest)obj);
        }

        /// <summary>
        /// Returns true if V3BulkDeparturesRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of V3BulkDeparturesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3BulkDeparturesRequest other)
        {
        ...
        public static bool operator ==(V3BulkDeparturesRequest left, V3BulkDeparturesRequest right)
        {
