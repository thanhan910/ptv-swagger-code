...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SiriDownstreamSubscriptionTopic : IEquatable<V3SiriDownstreamSubscriptionTopic>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3SiriDownstreamSubscriptionTopic)obj);
        }

        /// <summary>
        /// Returns true if V3SiriDownstreamSubscriptionTopic instances are equal
        /// </summary>
        /// <param name="other">Instance of V3SiriDownstreamSubscriptionTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SiriDownstreamSubscriptionTopic other)
        {
        ...
        public static bool operator ==(V3SiriDownstreamSubscriptionTopic left, V3SiriDownstreamSubscriptionTopic right)
        {
