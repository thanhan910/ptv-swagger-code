...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3RouteWithStatus : IEquatable<V3RouteWithStatus>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3RouteWithStatus)obj);
        }

        /// <summary>
        /// Returns true if V3RouteWithStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of V3RouteWithStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3RouteWithStatus other)
        {
        ...
        public static bool operator ==(V3RouteWithStatus left, V3RouteWithStatus right)
        {
