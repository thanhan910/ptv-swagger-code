...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopDepartureRequest : IEquatable<V3StopDepartureRequest>
    { 
        /// <summary>
        ...
        [DataMember(Name="route_directions")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3StopDepartureRequest)obj);
        }

        /// <summary>
        /// Returns true if V3StopDepartureRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopDepartureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopDepartureRequest other)
        {
            ...
            return 
                ...
                (
                    ...
                    RouteDirections.SequenceEqual(other.RouteDirections)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + RouteDirections.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(V3StopDepartureRequest left, V3StopDepartureRequest right)
        {
