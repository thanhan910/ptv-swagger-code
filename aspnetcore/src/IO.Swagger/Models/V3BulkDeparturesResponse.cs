...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3BulkDeparturesResponse : IEquatable<V3BulkDeparturesResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3BulkDeparturesResponse)obj);
        }

        /// <summary>
        /// Returns true if V3BulkDeparturesResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3BulkDeparturesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3BulkDeparturesResponse other)
        {
            ...
            return 
                ...
                (
                    ...
                    Disruptions != null &&
                    Disruptions.SequenceEqual(other.Disruptions)
                ) && 
                (
                    Status == other.Status ||
                    Status != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Disruptions != null)
                    hashCode = hashCode * 59 + Disruptions.GetHashCode();
                    if (Status != null)
        ...
        public static bool operator ==(V3BulkDeparturesResponse left, V3BulkDeparturesResponse right)
        {
