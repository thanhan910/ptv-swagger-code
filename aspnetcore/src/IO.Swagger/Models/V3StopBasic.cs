...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopBasic : IEquatable<V3StopBasic>
    { 
        /// <summary>
        /// Gets or Sets StopId
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3StopBasic)obj);
        }

        /// <summary>
        /// Returns true if V3StopBasic instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopBasic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopBasic other)
        {
        ...
        public static bool operator ==(V3StopBasic left, V3StopBasic right)
        {
