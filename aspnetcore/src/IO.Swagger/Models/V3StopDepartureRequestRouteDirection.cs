...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopDepartureRequestRouteDirection : IEquatable<V3StopDepartureRequestRouteDirection>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3StopDepartureRequestRouteDirection)obj);
        }

        /// <summary>
        /// Returns true if V3StopDepartureRequestRouteDirection instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopDepartureRequestRouteDirection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopDepartureRequestRouteDirection other)
        {
        ...
        public static bool operator ==(V3StopDepartureRequestRouteDirection left, V3StopDepartureRequestRouteDirection right)
        {
