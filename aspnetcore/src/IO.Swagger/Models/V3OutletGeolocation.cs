...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3OutletGeolocation : IEquatable<V3OutletGeolocation>
    { 
        /// <summary>
        ...
        [DataMember(Name="outlet_distance")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3OutletGeolocation)obj);
        }

        /// <summary>
        /// Returns true if V3OutletGeolocation instances are equal
        /// </summary>
        /// <param name="other">Instance of V3OutletGeolocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3OutletGeolocation other)
        {
            ...
            return 
                (
                    ...
                    OutletDistance != null &&
                    OutletDistance.Equals(other.OutletDistance)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + OutletDistance.GetHashCode();
        ...
        public static bool operator ==(V3OutletGeolocation left, V3OutletGeolocation right)
        {
