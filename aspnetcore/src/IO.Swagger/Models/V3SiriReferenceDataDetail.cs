...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SiriReferenceDataDetail : IEquatable<V3SiriReferenceDataDetail>
    { 
        /// <summary>
        ...
        [DataMember(Name="route_number_short")]
        ...
        [DataMember(Name="tracking_supplier_id")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3SiriReferenceDataDetail)obj);
        }

        /// <summary>
        /// Returns true if V3SiriReferenceDataDetail instances are equal
        /// </summary>
        /// <param name="other">Instance of V3SiriReferenceDataDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SiriReferenceDataDetail other)
        {
            ...
            return 
                ...
                (
                    RouteNumberShort == other.RouteNumberShort ||
                    RouteNumberShort != null &&
                    RouteNumberShort.Equals(other.RouteNumberShort)
                ) && 
                (
                ...
                (
                    TrackingSupplierId == other.TrackingSupplierId ||
                    TrackingSupplierId != null &&
                    TrackingSupplierId.Equals(other.TrackingSupplierId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (RouteNumberShort != null)
                    hashCode = hashCode * 59 + RouteNumberShort.GetHashCode();
                    if (DirectionId != null)
                    hashCode = hashCode * 59 + DirectionId.GetHashCode();
                    if (TrackingSupplierId != null)
                    hashCode = hashCode * 59 + TrackingSupplierId.GetHashCode();
                    if (RouteType != null)
        ...
        public static bool operator ==(V3SiriReferenceDataDetail left, V3SiriReferenceDataDetail right)
        {
