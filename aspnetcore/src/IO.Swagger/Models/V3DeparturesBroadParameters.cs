...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        [DataMember(Name="platform_numbers")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3DeparturesBroadParameters)obj);
        }
        ...
        public bool Equals(V3DeparturesBroadParameters other)
        {
            ...
            return 
                (
                    ...
                    PlatformNumbers.SequenceEqual(other.PlatformNumbers)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + PlatformNumbers.GetHashCode();
                    if (DirectionId != null)
        ...
        public static bool operator ==(V3DeparturesBroadParameters left, V3DeparturesBroadParameters right)
        {
