...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopModel : IEquatable<V3StopModel>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3StopModel)obj);
        }

        /// <summary>
        /// Returns true if V3StopModel instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopModel other)
        {
        ...
        public static bool operator ==(V3StopModel left, V3StopModel right)
        {
