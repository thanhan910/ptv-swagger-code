...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3VehiclePosition : IEquatable<V3VehiclePosition>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3VehiclePosition)obj);
        }

        /// <summary>
        /// Returns true if V3VehiclePosition instances are equal
        /// </summary>
        /// <param name="other">Instance of V3VehiclePosition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3VehiclePosition other)
        {
            ...
            return 
                ...
                (
                    ...
                    DatetimeUtc != null &&
                    DatetimeUtc.Equals(other.DatetimeUtc)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Easting != null)
                    hashCode = hashCode * 59 + Easting.GetHashCode();
                    if (Northing != null)
                    hashCode = hashCode * 59 + Northing.GetHashCode();
                    if (Direction != null)
                    ...
                    if (DatetimeUtc != null)
                    hashCode = hashCode * 59 + DatetimeUtc.GetHashCode();
                    if (ExpiryTime != null)
        ...
        public static bool operator ==(V3VehiclePosition left, V3VehiclePosition right)
        {
