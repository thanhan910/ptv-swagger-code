...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3BulkDeparturesStopResponse : IEquatable<V3BulkDeparturesStopResponse>
    { 
        /// <summary>
        /// Name of stop
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((V3BulkDeparturesStopResponse)obj);
        }

        /// <summary>
        /// Returns true if V3BulkDeparturesStopResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3BulkDeparturesStopResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3BulkDeparturesStopResponse other)
        {
        ...
        public static bool operator ==(V3BulkDeparturesStopResponse left, V3BulkDeparturesStopResponse right)
        {
