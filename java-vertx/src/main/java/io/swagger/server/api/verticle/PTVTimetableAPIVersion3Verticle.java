...
public class PTVTimetableAPIVersion3Verticle extends AbstractVerticle {
    static final Logger LOGGER = LoggerFactory.getLogger(PTVTimetableAPIVersion3Verticle.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
      ...
      return server.listen()
          .onSuccess(server -> LOGGER.info("PTVTimetableAPIVersion3Verticle started on port " + server.actualPort()));
      })
