...
class V3Run(object):
    ...
    def __init__(self, run_id=None, run_ref=None, route_id=None, route_type=None, final_stop_id=None, destination_name=None, status=None, direction_id=None, run_sequence=None, express_stop_count=None, vehicle_position=None, vehicle_descriptor=None, geopath=None):  # noqa: E501
