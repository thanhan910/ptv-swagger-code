...
class V3StopOnRoute(object):
    ...
    def __init__(self, disruption_ids=None, stop_suburb=None, route_type=None, stop_latitude=None, stop_longitude=None, stop_sequence=None, stop_ticket=None, stop_id=None, stop_name=None, stop_landmark=None):  # noqa: E501
