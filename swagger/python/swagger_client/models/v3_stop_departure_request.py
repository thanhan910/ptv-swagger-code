...
class V3StopDepartureRequest(object):
    ...
    def __init__(self, route_type=None, stop_id=None, max_results=None, gtfs=None, route_directions=None, _configuration=None):  # noqa: E501
    ...
    def max_results(self, max_results):
        ...
        """
        if (self._configuration.client_side_validation and
                max_results is not None and max_results > 2147483647):  # noqa: E501
    ...
    def route_directions(self, route_directions):
        ...
        """
        if self._configuration.client_side_validation and route_directions is None:
