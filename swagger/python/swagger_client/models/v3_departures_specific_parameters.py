...
class V3DeparturesSpecificParameters(object):
    ...
    def __init__(self, direction_id=None, gtfs=None, date_utc=None, max_results=None, include_cancelled=None, look_backwards=None, expand=None, include_geopath=None, _configuration=None):  # noqa: E501
