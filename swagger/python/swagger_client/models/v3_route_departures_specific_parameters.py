...
class V3RouteDeparturesSpecificParameters(object):
    ...
    def __init__(self, train_scheduled_timetables=None, scheduled_timetables=None, date_utc=None, max_results=None, include_cancelled=None, look_backwards=None, expand=None, include_geopath=None):  # noqa: E501
