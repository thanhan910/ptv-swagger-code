...
class V3StopDetails(object):
    ...
    def __init__(self, disruption_ids=None, station_type=None, station_description=None, route_type=None, stop_location=None, stop_amenities=None, stop_accessibility=None, stop_staffing=None, routes=None, stop_id=None, stop_name=None, stop_landmark=None):  # noqa: E501
