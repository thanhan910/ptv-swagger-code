...
class V3SiriDownstreamSubscription(object):
    ...
    def __init__(self, subscriber_ref=None, subscription_ref=None, message_type=None, siri_format=None, siri_version=None, consumer_address=None, initial_termination_time=None, validity_period_start=None, validity_period_end=None, preview_interval=None, topics=None, _configuration=None):  # noqa: E501
