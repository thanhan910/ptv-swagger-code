 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V3DeparturesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V3.DeparturesResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'stops' => 'map[string,\Swagger\Client\Model\V3StopModel]',
     ...
     * Gets stops
     *
     * @return map[string,\Swagger\Client\Model\V3StopModel]
     */
     ...
     * Sets stops
     *
     * @param map[string,\Swagger\Client\Model\V3StopModel] $stops A train station, tram stop, bus stop, regional coach stop or Night Bus stop
     *
     * @return $this
     */
