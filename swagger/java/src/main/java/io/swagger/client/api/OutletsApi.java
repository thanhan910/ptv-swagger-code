...
import io.swagger.client.model.V3OutletGeolocationResponse;
import io.swagger.client.model.V3OutletResponse;
...
public class OutletsApi {
    ...
    public V3OutletResponse outletsGetAllOutlets(Integer maxResults, String token, String devid, String signature) throws ApiException {
        ApiResponse<V3OutletResponse> resp = outletsGetAllOutletsWithHttpInfo(maxResults, token, devid, signature);
        return resp.getData();
    }
    ...
    public ApiResponse<V3OutletResponse> outletsGetAllOutletsWithHttpInfo(Integer maxResults, String token, String devid, String signature) throws ApiException {
        com.squareup.okhttp.Call call = outletsGetAllOutletsValidateBeforeCall(maxResults, token, devid, signature, null, null);
     ...
     */
    public com.squareup.okhttp.Call outletsGetAllOutletsAsync(Integer maxResults, String token, String devid, String signature, final ApiCallback<V3OutletResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = outletsGetAllOutletsValidateBeforeCall(maxResults, token, devid, signature, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V3OutletResponse>(){}.getType();
    ...
    public V3OutletGeolocationResponse outletsGetOutletsByGeolocation(Float latitude, Float longitude, Double maxDistance, Integer maxResults, String token, String devid, String signature) throws ApiException {
        ApiResponse<V3OutletGeolocationResponse> resp = outletsGetOutletsByGeolocationWithHttpInfo(latitude, longitude, maxDistance, maxResults, token, devid, signature);
        return resp.getData();
    }
    ...
    public ApiResponse<V3OutletGeolocationResponse> outletsGetOutletsByGeolocationWithHttpInfo(Float latitude, Float longitude, Double maxDistance, Integer maxResults, String token, String devid, String signature) throws ApiException {
        com.squareup.okhttp.Call call = outletsGetOutletsByGeolocationValidateBeforeCall(latitude, longitude, maxDistance, maxResults, token, devid, signature, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call outletsGetOutletsByGeolocationAsync(Float latitude, Float longitude, Double maxDistance, Integer maxResults, String token, String devid, String signature, final ApiCallback<V3OutletGeolocationResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = outletsGetOutletsByGeolocationValidateBeforeCall(latitude, longitude, maxDistance, maxResults, token, devid, signature, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V3OutletGeolocationResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
