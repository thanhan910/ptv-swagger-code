...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3DeparturesSpecificParameters :  IEquatable<V3DeparturesSpecificParameters>, IValidatableObject
    {
        /// <summary>
        /// Defines Expand
        /// </summary>
        ...
        public V3DeparturesSpecificParameters(int? directionId = default(int?), bool? gtfs = default(bool?), DateTime? dateUtc = default(DateTime?), int? maxResults = default(int?), bool? includeCancelled = default(bool?), bool? lookBackwards = default(bool?), List<ExpandEnum> expand = default(List<ExpandEnum>), bool? includeGeopath = default(bool?))
        {
        ...
        {
            return this.Equals(input as V3DeparturesSpecificParameters);
        }

        /// <summary>
        /// Returns true if V3DeparturesSpecificParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DeparturesSpecificParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DeparturesSpecificParameters input)
        {
            if (input == null)
                return false;
