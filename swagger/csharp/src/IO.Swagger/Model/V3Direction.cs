...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3Direction :  IEquatable<V3Direction>, IValidatableObject
    {
        /// <summary>
        ...
        public V3Direction(int? directionId = default(int?), string directionName = default(string), int? routeId = default(int?), int? routeType = default(int?))
        {
        ...
        {
            return this.Equals(input as V3Direction);
        }

        /// <summary>
        /// Returns true if V3Direction instances are equal
        /// </summary>
        /// <param name="input">Instance of V3Direction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3Direction input)
        {
            if (input == null)
                return false;
