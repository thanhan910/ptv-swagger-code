...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3StopGeosearch :  IEquatable<V3StopGeosearch>, IValidatableObject
    {
        /// <summary>
        ...
        public V3StopGeosearch(List<long?> disruptionIds = default(List<long?>), float? stopDistance = default(float?), string stopSuburb = default(string), string stopName = default(string), int? stopId = default(int?), int? routeType = default(int?), List<Object> routes = default(List<Object>), float? stopLatitude = default(float?), float? stopLongitude = default(float?), string stopLandmark = default(string), int? stopSequence = default(int?))
        {
        ...
        {
            return this.Equals(input as V3StopGeosearch);
        }

        /// <summary>
        /// Returns true if V3StopGeosearch instances are equal
        /// </summary>
        /// <param name="input">Instance of V3StopGeosearch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopGeosearch input)
        {
            if (input == null)
                return false;
