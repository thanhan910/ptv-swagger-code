...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3DirectionsResponse :  IEquatable<V3DirectionsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public V3DirectionsResponse(List<V3DirectionWithDescription> directions = default(List<V3DirectionWithDescription>), V3Status status = default(V3Status))
        {
        ...
        {
            return this.Equals(input as V3DirectionsResponse);
        }

        /// <summary>
        /// Returns true if V3DirectionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DirectionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DirectionsResponse input)
        {
            if (input == null)
                return false;
