...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3StopDepartureRequest :  IEquatable<V3StopDepartureRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public V3StopDepartureRequest(RouteTypeEnum? routeType = default(RouteTypeEnum?), int? stopId = default(int?), int? maxResults = default(int?), bool? gtfs = default(bool?), List<V3StopDepartureRequestRouteDirection> routeDirections = default(List<V3StopDepartureRequestRouteDirection>))
        {
            ...
            {
                throw new InvalidDataException("routeDirections is a required property for V3StopDepartureRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as V3StopDepartureRequest);
        }

        /// <summary>
        /// Returns true if V3StopDepartureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of V3StopDepartureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopDepartureRequest input)
        {
            if (input == null)
                return false;
