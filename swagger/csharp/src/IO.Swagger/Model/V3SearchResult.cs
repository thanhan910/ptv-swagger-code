...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SearchResult :  IEquatable<V3SearchResult>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as V3SearchResult);
        }

        /// <summary>
        /// Returns true if V3SearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of V3SearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SearchResult input)
        {
            if (input == null)
                return false;
