...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3DisruptionsResponse :  IEquatable<V3DisruptionsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public V3DisruptionsResponse(V3Disruptions disruptions = default(V3Disruptions), V3Status status = default(V3Status))
        {
        ...
        {
            return this.Equals(input as V3DisruptionsResponse);
        }

        /// <summary>
        /// Returns true if V3DisruptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DisruptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DisruptionsResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Disruptions.Equals(input.Disruptions))
                ) && 
                (
