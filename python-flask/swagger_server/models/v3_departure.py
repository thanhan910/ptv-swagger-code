...
class V3Departure(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'V3Departure':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The V3.Departure of this V3Departure.  # noqa: E501
        :rtype: V3Departure
        """
