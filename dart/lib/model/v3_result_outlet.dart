...
/* Any additional notes for the outlet such as 'Buy pre-loaded myki cards only'. May be null/empty. */
  ...
  static List<V3ResultOutlet> listFromJson(List<dynamic> json) {
    return json == null ? new List<V3ResultOutlet>() : json.map((value) => new V3ResultOutlet.fromJson(value)).toList();
  }

  static Map<String, V3ResultOutlet> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, V3ResultOutlet>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new V3ResultOutlet.fromJson(value));
    }
    return map;
  }
}
