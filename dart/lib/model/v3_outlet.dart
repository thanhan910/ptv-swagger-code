...
/* Any additional notes for the outlet such as 'Buy pre-loaded myki cards only'. May be null/empty. */
  ...
  static List<V3Outlet> listFromJson(List<dynamic> json) {
    return json == null ? new List<V3Outlet>() : json.map((value) => new V3Outlet.fromJson(value)).toList();
  }

  static Map<String, V3Outlet> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, V3Outlet>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new V3Outlet.fromJson(value));
    }
    return map;
  }
}
