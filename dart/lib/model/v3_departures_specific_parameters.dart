...
/* Indicates if the route geopath should be returned */
  ...
  @override
  String toString() {
    return 'V3DeparturesSpecificParameters[directionId=$directionId, gtfs=$gtfs, dateUtc=$dateUtc, maxResults=$maxResults, includeCancelled=$includeCancelled, lookBackwards=$lookBackwards, expand=$expand, includeGeopath=$includeGeopath, ]';
  }
  ...
  static List<V3DeparturesSpecificParameters> listFromJson(List<dynamic> json) {
    return json == null ? new List<V3DeparturesSpecificParameters>() : json.map((value) => new V3DeparturesSpecificParameters.fromJson(value)).toList();
  }

  static Map<String, V3DeparturesSpecificParameters> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, V3DeparturesSpecificParameters>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new V3DeparturesSpecificParameters.fromJson(value));
    }
    return map;
  }
}
