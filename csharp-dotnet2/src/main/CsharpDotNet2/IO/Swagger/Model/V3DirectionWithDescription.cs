...
namespace IO.Swagger.Model {
  ...
  public class V3DirectionWithDescription {
    /// <summary>
    /// Gets or Sets RouteDirectionDescription
    /// </summary>
    [DataMember(Name="route_direction_description", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "route_direction_description")]
    ...
    public override string ToString()  {
      ...
      sb.Append("  RouteDirectionDescription: ").Append(RouteDirectionDescription).Append("\n");
