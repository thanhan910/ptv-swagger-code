...
import { V3BulkDeparturesRouteDirectionResponse } from './v3-bulk-departures-route-direction-response';
import { V3Departure } from './v3-departure';
import {
    V3BulkDeparturesRouteDirectionResponse,V3Departure,
} from ".";
 ...
 * @enum {string}
 */
export enum V3BulkDeparturesUpdateResponseRouteDirectionStatusEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1
}
