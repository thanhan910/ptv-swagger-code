...
import { V3BulkDeparturesStopResponse } from './v3-bulk-departures-stop-response';
import { V3BulkDeparturesUpdateResponse } from './v3-bulk-departures-update-response';
...
import {
    V3BulkDeparturesStopResponse,V3BulkDeparturesUpdateResponse,V3Direction,V3Disruption,V3Run,V3Status,
} from ".";
