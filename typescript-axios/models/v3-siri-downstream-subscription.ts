...
import { V3SiriDownstreamSubscriptionTopic } from './v3-siri-downstream-subscription-topic';
import {
 ...
 * @enum {string}
 */
export enum V3SiriDownstreamSubscriptionMessageTypeEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1
}
/**
 ...
 * @enum {string}
 */
export enum V3SiriDownstreamSubscriptionSiriFormatEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1
}
