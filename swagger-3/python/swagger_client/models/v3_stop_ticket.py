...
class V3StopTicket(object):
    ...
    def __init__(self, ticket_type=None, zone=None, is_free_fare_zone=None, ticket_machine=None, ticket_checks=None, vline_reservation=None, ticket_zones=None):  # noqa: E501
