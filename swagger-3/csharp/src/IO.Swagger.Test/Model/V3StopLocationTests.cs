...
namespace IO.Swagger.Test
{
    ...
    /// </remarks>
    [TestFixture]
    public class V3StopLocationTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" V3StopLocation
            //Assert.IsInstanceOfType<V3StopLocation> (instance, "variable 'instance' is a V3StopLocation");
        }
