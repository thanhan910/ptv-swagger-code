...
namespace IO.Swagger.Test
{
    ...
    public class RoutesApiTests
    {
        ...
        /// </summary>
        [Test]
        public void RoutesOneOrMoreRoutesTest()
        {
            ...
            //var response = instance.RoutesOneOrMoreRoutes(routeTypes, routeName, token, devid, signature);
            //Assert.IsInstanceOf<V3RouteResponse> (response, "response is V3RouteResponse");
        }
        /// <summary>
        /// Test RoutesRouteFromId
        /// </summary>
        [Test]
        public void RoutesRouteFromIdTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? routeId = null;
            ...
            //string devid = null;
            //string signature = null;
            //var response = instance.RoutesRouteFromId(routeId, includeGeopath, geopathUtc, token, devid, signature);
            //Assert.IsInstanceOf<V3RouteResponse> (response, "response is V3RouteResponse");
        }
    }
