...
public class V3SiriLineRefDirectionRefsDictionary   {
  private Map<String, List<V3SiriReferenceDataDetail>> directionRefs = new HashMap<String, List<V3SiriReferenceDataDetail>>();  private Map<String, String> unmatchedDirectionRefs = new HashMap<String, String>();
