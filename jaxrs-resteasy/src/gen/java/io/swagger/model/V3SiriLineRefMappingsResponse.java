...
public class V3SiriLineRefMappingsResponse   {
  private String mappingVersion = null;  private Map<String, V3SiriLineRefDirectionRefsDictionary> lineRefs = new HashMap<String, V3SiriLineRefDirectionRefsDictionary>();  private V3Status status = null;
