...
public class V3Disruptions   {
  private List<V3Disruption> general = new ArrayList<V3Disruption>();  private List<V3Disruption> metroTrain = new ArrayList<V3Disruption>();  private List<V3Disruption> metroTram = new ArrayList<V3Disruption>();  private List<V3Disruption> metroBus = new ArrayList<V3Disruption>();  private List<V3Disruption> regionalTrain = new ArrayList<V3Disruption>();  private List<V3Disruption> regionalCoach = new ArrayList<V3Disruption>();  private List<V3Disruption> regionalBus = new ArrayList<V3Disruption>();  private List<V3Disruption> schoolBus = new ArrayList<V3Disruption>();  private List<V3Disruption> telebus = new ArrayList<V3Disruption>();  private List<V3Disruption> nightBus = new ArrayList<V3Disruption>();  private List<V3Disruption> ferry = new ArrayList<V3Disruption>();  private List<V3Disruption> interstateTrain = new ArrayList<V3Disruption>();  private List<V3Disruption> skybus = new ArrayList<V3Disruption>();  private List<V3Disruption> taxi = new ArrayList<V3Disruption>();
