...
public class V3SiriStopsRefsDictionary   {
  private Map<String, V3SiriReferenceDataDetail> stopPointRefs = new HashMap<String, V3SiriReferenceDataDetail>();  private Map<String, String> unmatchedStopPointRefs = new HashMap<String, String>();
