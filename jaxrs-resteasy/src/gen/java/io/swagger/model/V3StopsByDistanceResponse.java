...
public class V3StopsByDistanceResponse   {
  private List<V3StopGeosearch> stops = new ArrayList<V3StopGeosearch>();  private Map<String, V3Disruption> disruptions = new HashMap<String, V3Disruption>();  private V3Status status = null;
