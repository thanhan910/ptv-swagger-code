...
public class V3DeparturesResponse   {
  private List<V3Departure> departures = new ArrayList<V3Departure>();  private Map<String, V3StopModel> stops = new HashMap<String, V3StopModel>();  private Map<String, Object> routes = new HashMap<String, Object>();  private Map<String, V3Run> runs = new HashMap<String, V3Run>();  private Map<String, V3Direction> directions = new HashMap<String, V3Direction>();  private Map<String, V3Disruption> disruptions = new HashMap<String, V3Disruption>();  private V3Status status = null;
