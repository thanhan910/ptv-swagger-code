...
public class V3SearchResult   {
  private List<V3ResultStop> stops = new ArrayList<V3ResultStop>();  private List<V3ResultRoute> routes = new ArrayList<V3ResultRoute>();  private List<V3ResultOutlet> outlets = new ArrayList<V3ResultOutlet>();  private V3Status status = null;
