...
public class V3BulkDeparturesRequest   {
  private List<V3StopDepartureRequest> requests = new ArrayList<V3StopDepartureRequest>();  private Date dateUtc = null;  private Boolean lookBackwards = null;  private Boolean includeCancelled = null;  private Boolean includeGeopath = null;  /**
   * Gets or Sets expand
   */
