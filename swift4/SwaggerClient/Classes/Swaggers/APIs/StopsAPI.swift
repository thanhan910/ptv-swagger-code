...
open class StopsAPI {
    ...
    /**
     ...
     - parameter stopId: (path) Identifier of stop; values returned by Stops API      - parameter routeType: (path) Number identifying transport mode; values returned via RouteTypes API      - parameter stopLocation: (query) Indicates if stop location information will be returned (default &#x3D; false) (optional)     - parameter stopAmenities: (query) Indicates if stop amenity information will be returned (default &#x3D; false) (optional)     - parameter stopAccessibility: (query) Indicates if stop accessibility information will be returned (default &#x3D; false) (optional)     - parameter stopContact: (query) Indicates if stop contact information will be returned (default &#x3D; false) (optional)     - parameter stopTicket: (query) Indicates if stop ticket information will be returned (default &#x3D; false) (optional)     - parameter gtfs: (query) Incdicates whether the stop_id is a GTFS ID or not (optional)     - parameter stopStaffing: (query) Indicates if stop staffing information will be returned (default &#x3D; false) (optional)     - parameter stopDisruptions: (query) Indicates if stop disruption information will be returned (default &#x3D; false) (optional)     - parameter token: (query) Please ignore (optional)     - parameter devid: (query) Your developer id (optional)     - parameter signature: (query) Authentication signature for request (optional)
  ...
  "status" : {
    ...
    /**
     ...
     - parameter latitude: (path) Geographic coordinate of latitude      - parameter longitude: (path) Geographic coordinate of longitude      - parameter routeTypes: (query) Filter by route_type; values returned via RouteTypes API (optional)     - parameter maxResults: (query) Maximum number of results returned (default &#x3D; 30) (optional)     - parameter maxDistance: (query) Filter by maximum distance (in metres) from location specified via latitude and longitude parameters (default &#x3D; 300) (optional)     - parameter stopDisruptions: (query) Indicates if stop disruption information will be returned (default &#x3D; false) (optional)     - parameter token: (query) Please ignore (optional)     - parameter devid: (query) Your developer id (optional)     - parameter signature: (query) Authentication signature for request (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
  ...
  "status" : {
    ...
    /**
     ...
     - parameter routeId: (path) Identifier of route; values returned by Routes API - v3/routes      - parameter routeType: (path) Number identifying transport mode; values returned via RouteTypes API      - parameter directionId: (query) An optional direction; values returned by Directions API. When this is set, stop sequence information is returned in the response. (optional)     - parameter stopDisruptions: (query) Indicates if stop disruption information will be returned (default &#x3D; false) (optional)     - parameter includeGeopath: (query) Indicates if geopath data will be returned (default &#x3D; false) (optional)     - parameter geopathUtc: (query) Filter geopaths by date (ISO 8601 UTC format) (default &#x3D; current date) (optional)     - parameter token: (query) Please ignore (optional)     - parameter devid: (query) Your developer id (optional)     - parameter signature: (query) Authentication signature for request (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func stopsStopsForRoute(routeId: Int, routeType: RouteType_stopsStopsForRoute, directionId: Int? = nil, stopDisruptions: Bool? = nil, includeGeopath: Bool? = nil, geopathUtc: Date? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3StopsOnRouteResponse?,_ error: Error?) -> Void)) {
  ...
  "status" : {
     ...
     */
    open class func stopsStopsForRouteWithRequestBuilder(routeId: Int, routeType: RouteType_stopsStopsForRoute, directionId: Int? = nil, stopDisruptions: Bool? = nil, includeGeopath: Bool? = nil, geopathUtc: Date? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3StopsOnRouteResponse> {
