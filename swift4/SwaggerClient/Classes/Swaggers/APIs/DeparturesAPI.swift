...
open class DeparturesAPI {
    ...
    /**
     ...
     - parameter routeType: (path) Number identifying transport mode; values returned via RouteTypes API      - parameter stopId: (path) Identifier of stop; values returned by Stops API      - parameter platformNumbers: (query) Filter by platform number at stop (optional)     - parameter directionId: (query) Filter by identifier of direction of travel; values returned by Directions API - /v3/directions/route/{route_id} (optional)     - parameter gtfs: (query) Indicates that stop_id parameter will accept \&quot;GTFS stop_id\&quot; data (optional)     - parameter dateUtc: (query) Filter by the date and time of the request (ISO 8601 UTC format) (default &#x3D; current date and time) (optional)     - parameter maxResults: (query) Maximum number of results returned (optional)     - parameter includeCancelled: (query) Indicates if cancelled services (if they exist) are returned (default &#x3D; false) - metropolitan train only (optional)     - parameter lookBackwards: (query) Indicates if filtering runs (and their departures) to those that arrive at destination before date_utc (default &#x3D; false). Requires max_results &amp;gt; 0. (optional)     - parameter expand: (query) List of objects to be returned in full (i.e. expanded) - options include: All, Stop, Route, Run, Direction, Disruption, VehiclePosition, VehicleDescriptor or None.  Run must be expanded to receive VehiclePosition and VehicleDescriptor information. (optional)     - parameter includeGeopath: (query) Indicates if the route geopath should be returned (optional)     - parameter token: (query) Please ignore (optional)     - parameter devid: (query) Your developer id (optional)     - parameter signature: (query) Authentication signature for request (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func departuresGetForStop(routeType: RouteType_departuresGetForStop, stopId: Int, platformNumbers: [Int]? = nil, directionId: Int? = nil, gtfs: Bool? = nil, dateUtc: Date? = nil, maxResults: Int? = nil, includeCancelled: Bool? = nil, lookBackwards: Bool? = nil, expand: [String]? = nil, includeGeopath: Bool? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3DeparturesResponse?,_ error: Error?) -> Void)) {
  ...
  "status" : {
     ...
     */
    open class func departuresGetForStopWithRequestBuilder(routeType: RouteType_departuresGetForStop, stopId: Int, platformNumbers: [Int]? = nil, directionId: Int? = nil, gtfs: Bool? = nil, dateUtc: Date? = nil, maxResults: Int? = nil, includeCancelled: Bool? = nil, lookBackwards: Bool? = nil, expand: [String]? = nil, includeGeopath: Bool? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3DeparturesResponse> {
    ...
    /**
     ...
     - parameter routeType: (path) Number identifying transport mode; values returned via RouteTypes API      - parameter stopId: (path) Identifier of stop; values returned by Stops API      - parameter routeId: (path) Identifier of route; values returned by Routes API - v3/routes      - parameter directionId: (query) Filter by identifier of direction of travel; values returned by Directions API - /v3/directions/route/{route_id} (optional)     - parameter gtfs: (query) Indicates that stop_id parameter will accept \&quot;GTFS stop_id\&quot; data (optional)     - parameter dateUtc: (query) Filter by the date and time of the request (ISO 8601 UTC format) (default &#x3D; current date and time) (optional)     - parameter maxResults: (query) Maximum number of results returned (optional)     - parameter includeCancelled: (query) Indicates if cancelled services (if they exist) are returned (default &#x3D; false) - metropolitan train only (optional)     - parameter lookBackwards: (query) Indicates if filtering runs (and their departures) to those that arrive at destination before date_utc (default &#x3D; false). Requires max_results &amp;gt; 0. (optional)     - parameter expand: (query) List of objects to be returned in full (i.e. expanded) - options include: All, Stop, Route, Run, Direction, Disruption, VehiclePosition, VehicleDescriptor or None.  Run must be expanded to receive VehiclePosition and VehicleDescriptor information. (optional)     - parameter includeGeopath: (query) Indicates if the route geopath should be returned (optional)     - parameter token: (query) Please ignore (optional)     - parameter devid: (query) Your developer id (optional)     - parameter signature: (query) Authentication signature for request (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func departuresGetForStopAndRoute(routeType: RouteType_departuresGetForStopAndRoute, stopId: Int, routeId: String, directionId: Int? = nil, gtfs: Bool? = nil, dateUtc: Date? = nil, maxResults: Int? = nil, includeCancelled: Bool? = nil, lookBackwards: Bool? = nil, expand: [String]? = nil, includeGeopath: Bool? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3DeparturesResponse?,_ error: Error?) -> Void)) {
