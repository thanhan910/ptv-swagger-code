...
open class FareEstimateAPI {
    ...
    /**
     ...
     - parameter minZone: (path) Minimum Zone travelled through ie. 1      - parameter maxZone: (path) Maximum Zone travelled through id. 6      - parameter journeyTouchOnUtc: (query) JourneyTouchOnUtc in format yyyy-M-d h:m (e.g 2016-5-31 16:53). (optional)     - parameter journeyTouchOffUtc: (query) JourneyTouchOffUtc in format yyyy-M-d h:m (e.g 2016-5-31 16:53). (optional)     - parameter isJourneyInFreeTramZone: (query)  (optional)     - parameter travelledRouteTypes: (query)  (optional)     - parameter token: (query) Please ignore (optional)     - parameter devid: (query) Your developer id (optional)     - parameter signature: (query) Authentication signature for request (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func fareEstimateGetFareEstimateByZone(minZone: Int, maxZone: Int, journeyTouchOnUtc: Date? = nil, journeyTouchOffUtc: Date? = nil, isJourneyInFreeTramZone: Bool? = nil, travelledRouteTypes: [Int]? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3FareEstimateResponse?,_ error: Error?) -> Void)) {
  ...
  "FareEstimateResult" : {
     ...
     */
    open class func fareEstimateGetFareEstimateByZoneWithRequestBuilder(minZone: Int, maxZone: Int, journeyTouchOnUtc: Date? = nil, journeyTouchOffUtc: Date? = nil, isJourneyInFreeTramZone: Bool? = nil, travelledRouteTypes: [Int]? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3FareEstimateResponse> {
