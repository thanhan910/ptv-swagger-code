//
// V3DeparturesBroadParameters.swift
//
...
public struct V3DeparturesBroadParameters: Codable {
    ...
    public var platformNumbers: [Int]?
    ...
    public init(platformNumbers: [Int]? = nil, directionId: Int? = nil, gtfs: Bool? = nil, dateUtc: Date? = nil, maxResults: Int? = nil, includeCancelled: Bool? = nil, lookBackwards: Bool? = nil, expand: [Expand]? = nil, includeGeopath: Bool? = nil) { 
        self.platformNumbers = platformNumbers
