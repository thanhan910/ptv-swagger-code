...
public struct V3SearchParameters: Codable {
    ...
    public init(routeTypes: [RouteTypes]? = nil, latitude: Float? = nil, longitude: Float? = nil, maxDistance: Float? = nil, includeAddresses: Bool? = nil, includeOutlets: Bool? = nil, matchStopBySuburb: Bool? = nil, matchRouteBySuburb: Bool? = nil, matchStopByGtfsStopId: Bool? = nil) { 
