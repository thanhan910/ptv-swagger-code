//
// V3SiriProductionTimetableSubscriptionRequest.swift
//
...
public struct V3SiriProductionTimetableSubscriptionRequest: Codable {
    ...
    public init(startTime: Date, endTime: Date, subscriberRef: String, subscriptionRef: String, siriFormat: SiriFormat, siriVersion: String, consumerAddress: String, initialTerminationTime: Date, topics: [V3SiriSubscriptionTopic]) { 
