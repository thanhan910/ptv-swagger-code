 ...
 */
V3ResultStop.prototype.stopDistance = undefined;

/**
 * suburb of stop
 * @member {String} stopSuburb
 */
V3ResultStop.prototype.stopSuburb = undefined;

/**
 * Transport mode identifier
 * @member {Number} routeType
 */
V3ResultStop.prototype.routeType = undefined;
 ...
 */
V3ResultStop.prototype.stopLatitude = undefined;

/**
 * Geographic coordinate of longitude at stop
 * @member {Number} stopLongitude
 */
V3ResultStop.prototype.stopLongitude = undefined;

/**
 * Sequence of the stop on the route/run; return 0 when route_id or run_id not specified. Order ascendingly by this field (when non zero) to get physical order (earliest first) of stops on the route_id/run_id.
 * @member {Number} stopSequence
 */
V3ResultStop.prototype.stopSequence = undefined;

/**
 * Stop identifier
 * @member {Number} stopId
 */
V3ResultStop.prototype.stopId = undefined;

/**
 * Name of stop
 * @member {String} stopName
 */
V3ResultStop.prototype.stopName = undefined;

/**
 * Landmark in proximity of stop
 * @member {String} stopLandmark
 */
V3ResultStop.prototype.stopLandmark = undefined;
