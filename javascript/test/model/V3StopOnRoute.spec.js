...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V3StopOnRoute', function() {
      beforeEach(function() {
        instance = new PtvTimetableApiVersion3.V3StopOnRoute();
      });

      it('should create an instance of V3StopOnRoute', function() {
        // TODO: update the code to test V3StopOnRoute
        expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopOnRoute);
      });
      ...
      it('should have the property stopTicket (base name: "stop_ticket")', function() {
        // TODO: update the code to test the property stopTicket
        expect(instance).to.have.property('stopTicket');
        // expect(instance.stopTicket).to.be(expectedValueLiteral);
      });
