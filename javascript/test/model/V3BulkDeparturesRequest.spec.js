...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V3BulkDeparturesRequest', function() {
      beforeEach(function() {
        instance = new PtvTimetableApiVersion3.V3BulkDeparturesRequest();
      });

      it('should create an instance of V3BulkDeparturesRequest', function() {
        // TODO: update the code to test V3BulkDeparturesRequest
        expect(instance).to.be.a(PtvTimetableApiVersion3.V3BulkDeparturesRequest);
      });
