...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V3StopDepartureRequest', function() {
      beforeEach(function() {
        instance = new PtvTimetableApiVersion3.V3StopDepartureRequest();
      });

      it('should create an instance of V3StopDepartureRequest', function() {
        // TODO: update the code to test V3StopDepartureRequest
        expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopDepartureRequest);
      });
      ...
      it('should have the property gtfs (base name: "gtfs")', function() {
        // TODO: update the code to test the property gtfs
        expect(instance).to.have.property('gtfs');
        // expect(instance.gtfs).to.be(expectedValueLiteral);
      });

      it('should have the property routeDirections (base name: "route_directions")', function() {
        // TODO: update the code to test the property routeDirections
        expect(instance).to.have.property('routeDirections');
        // expect(instance.routeDirections).to.be(expectedValueLiteral);
      });
