  ...
  describe('(package)', function() {
    describe('V3VehiclePosition', function() {
      ...
      it('should create an instance of V3VehiclePosition', function() {
        // TODO: update the code to test V3VehiclePosition
      ...
      it('should have the property easting (base name: "easting")', function() {
        // TODO: update the code to test the property easting
        expect(instance).to.have.property('easting');
        // expect(instance.easting).to.be(expectedValueLiteral);
      });

      it('should have the property northing (base name: "northing")', function() {
        // TODO: update the code to test the property northing
        expect(instance).to.have.property('northing');
        // expect(instance.northing).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property bearing (base name: "bearing")', function() {
        // TODO: update the code to test the property bearing
        expect(instance).to.have.property('bearing');
        // expect(instance.bearing).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property datetimeUtc (base name: "datetime_utc")', function() {
        // TODO: update the code to test the property datetimeUtc
        expect(instance).to.have.property('datetimeUtc');
        // expect(instance.datetimeUtc).to.be(expectedValueLiteral);
      });
