...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V3RunResponse', function() {
      beforeEach(function() {
        instance = new PtvTimetableApiVersion3.V3RunResponse();
      });

      it('should create an instance of V3RunResponse', function() {
        // TODO: update the code to test V3RunResponse
        expect(instance).to.be.a(PtvTimetableApiVersion3.V3RunResponse);
      });
