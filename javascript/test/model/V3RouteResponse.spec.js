...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V3RouteResponse', function() {
      beforeEach(function() {
        instance = new PtvTimetableApiVersion3.V3RouteResponse();
      });

      it('should create an instance of V3RouteResponse', function() {
        // TODO: update the code to test V3RouteResponse
        expect(instance).to.be.a(PtvTimetableApiVersion3.V3RouteResponse);
      });
