...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V3RunsResponse', function() {
      beforeEach(function() {
        instance = new PtvTimetableApiVersion3.V3RunsResponse();
      });

      it('should create an instance of V3RunsResponse', function() {
        // TODO: update the code to test V3RunsResponse
        expect(instance).to.be.a(PtvTimetableApiVersion3.V3RunsResponse);
      });
