...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V3StopPoint', function() {
      beforeEach(function() {
        instance = new PtvTimetableApiVersion3.V3StopPoint();
      });

      it('should create an instance of V3StopPoint', function() {
        // TODO: update the code to test V3StopPoint
        expect(instance).to.be.a(PtvTimetableApiVersion3.V3StopPoint);
      });
