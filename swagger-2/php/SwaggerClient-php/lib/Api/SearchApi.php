...
class SearchApi
{
    ...
    protected function searchSearchRequest($search_term, $route_types = null, $latitude = null, $longitude = null, $max_distance = null, $include_addresses = null, $include_outlets = null, $match_stop_by_suburb = null, $match_route_by_suburb = null, $match_stop_by_gtfs_stop_id = null, $token = null, $devid = null, $signature = null)
    {
        ...
        if ($include_outlets !== null) {
            $queryParams['include_outlets'] = ObjectSerializer::toQueryValue($include_outlets);
        }
        // query params
        if ($match_stop_by_suburb !== null) {
            $queryParams['match_stop_by_suburb'] = ObjectSerializer::toQueryValue($match_stop_by_suburb);
        }
        // query params
        if ($match_route_by_suburb !== null) {
            $queryParams['match_route_by_suburb'] = ObjectSerializer::toQueryValue($match_route_by_suburb);
        }
        // query params
        if ($match_stop_by_gtfs_stop_id !== null) {
            $queryParams['match_stop_by_gtfs_stop_id'] = ObjectSerializer::toQueryValue($match_stop_by_gtfs_stop_id);
        }
        // query params
        if ($token !== null) {
