...
class StopsApi
{
    ...
    protected function stopsStopDetailsRequest($stop_id, $route_type, $stop_location = null, $stop_amenities = null, $stop_accessibility = null, $stop_contact = null, $stop_ticket = null, $gtfs = null, $stop_staffing = null, $stop_disruptions = null, $token = null, $devid = null, $signature = null)
    {
        ...
        if ($stop_location !== null) {
            $queryParams['stop_location'] = ObjectSerializer::toQueryValue($stop_location);
        }
        // query params
        if ($stop_amenities !== null) {
            $queryParams['stop_amenities'] = ObjectSerializer::toQueryValue($stop_amenities);
        }
        // query params
        if ($stop_accessibility !== null) {
            $queryParams['stop_accessibility'] = ObjectSerializer::toQueryValue($stop_accessibility);
        }
        // query params
        if ($stop_contact !== null) {
            $queryParams['stop_contact'] = ObjectSerializer::toQueryValue($stop_contact);
        }
        // query params
        if ($stop_ticket !== null) {
            $queryParams['stop_ticket'] = ObjectSerializer::toQueryValue($stop_ticket);
        }
        // query params
        if ($gtfs !== null) {
        ...
        if ($stop_staffing !== null) {
            $queryParams['stop_staffing'] = ObjectSerializer::toQueryValue($stop_staffing);
        }
        // query params
        if ($stop_disruptions !== null) {
            $queryParams['stop_disruptions'] = ObjectSerializer::toQueryValue($stop_disruptions);
        }
        // query params
        if ($token !== null) {
