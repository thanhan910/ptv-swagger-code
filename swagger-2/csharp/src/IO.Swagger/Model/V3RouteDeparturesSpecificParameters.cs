...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3RouteDeparturesSpecificParameters :  IEquatable<V3RouteDeparturesSpecificParameters>, IValidatableObject
    {
        /// <summary>
        /// Defines Expand
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V3RouteDeparturesSpecificParameters" /> class.
        /// </summary>
        /// <param name="trainScheduledTimetables">DEPRECATED - use &#x60;scheduled_timetables&#x60; instead.</param>
        /// <param name="scheduledTimetables">When set to true, all timetable information returned by Chronos will be sourced from the scheduled timetables,  while when set to false (default state), the operational timetables will be used where available..</param>
        ...
        public V3RouteDeparturesSpecificParameters(bool? trainScheduledTimetables = default(bool?), bool? scheduledTimetables = default(bool?), DateTime? dateUtc = default(DateTime?), int? maxResults = default(int?), bool? includeCancelled = default(bool?), bool? lookBackwards = default(bool?), List<ExpandEnum> expand = default(List<ExpandEnum>), bool? includeGeopath = default(bool?))
        {
        ...
        {
            return this.Equals(input as V3RouteDeparturesSpecificParameters);
        }

        /// <summary>
        /// Returns true if V3RouteDeparturesSpecificParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of V3RouteDeparturesSpecificParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3RouteDeparturesSpecificParameters input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TrainScheduledTimetables == input.TrainScheduledTimetables ||
                    (this.TrainScheduledTimetables != null &&
                    this.TrainScheduledTimetables.Equals(input.TrainScheduledTimetables))
                ) && 
                (
                    this.ScheduledTimetables == input.ScheduledTimetables ||
                    (this.ScheduledTimetables != null &&
                    this.ScheduledTimetables.Equals(input.ScheduledTimetables))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.TrainScheduledTimetables != null)
                    hashCode = hashCode * 59 + this.TrainScheduledTimetables.GetHashCode();
                if (this.ScheduledTimetables != null)
                    hashCode = hashCode * 59 + this.ScheduledTimetables.GetHashCode();
