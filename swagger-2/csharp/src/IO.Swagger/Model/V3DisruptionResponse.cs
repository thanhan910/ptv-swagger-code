...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3DisruptionResponse :  IEquatable<V3DisruptionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public V3DisruptionResponse(V3Disruption disruption = default(V3Disruption), V3Status status = default(V3Status))
        {
        ...
        {
            return this.Equals(input as V3DisruptionResponse);
        }

        /// <summary>
        /// Returns true if V3DisruptionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DisruptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DisruptionResponse input)
        {
            if (input == null)
                return false;
