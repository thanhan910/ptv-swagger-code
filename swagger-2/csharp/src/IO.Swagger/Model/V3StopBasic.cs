...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopBasic :  IEquatable<V3StopBasic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3StopBasic" /> class.
        /// </summary>
        /// <param name="stopId">stopId.</param>
        /// <param name="stopName">stopName.</param>
        public V3StopBasic(int? stopId = default(int?), string stopName = default(string))
        {
            this.StopId = stopId;
        ...
        {
            return this.Equals(input as V3StopBasic);
        }

        /// <summary>
        /// Returns true if V3StopBasic instances are equal
        /// </summary>
        /// <param name="input">Instance of V3StopBasic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopBasic input)
        {
            if (input == null)
                return false;
