...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SiriEstimatedTimetableSubscriptionRequest :  IEquatable<V3SiriEstimatedTimetableSubscriptionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V3SiriEstimatedTimetableSubscriptionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3SiriEstimatedTimetableSubscriptionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3SiriEstimatedTimetableSubscriptionRequest" /> class.
        /// </summary>
        /// <param name="previewInterval">Siri Preview Interval (required).</param>
        ...
        public V3SiriEstimatedTimetableSubscriptionRequest(string previewInterval = default(string), string subscriberRef = default(string), string subscriptionRef = default(string), SiriFormatEnum siriFormat = default(SiriFormatEnum), string siriVersion = default(string), string consumerAddress = default(string), DateTime? initialTerminationTime = default(DateTime?), List<V3SiriSubscriptionTopic> topics = default(List<V3SiriSubscriptionTopic>))
        {
            // to ensure "previewInterval" is required (not null)
            if (previewInterval == null)
            {
                throw new InvalidDataException("previewInterval is a required property for V3SiriEstimatedTimetableSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("subscriberRef is a required property for V3SiriEstimatedTimetableSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("subscriptionRef is a required property for V3SiriEstimatedTimetableSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            if (siriFormat == null)
            {
                throw new InvalidDataException("siriFormat is a required property for V3SiriEstimatedTimetableSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            if (siriVersion == null)
            {
                throw new InvalidDataException("siriVersion is a required property for V3SiriEstimatedTimetableSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("consumerAddress is a required property for V3SiriEstimatedTimetableSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("initialTerminationTime is a required property for V3SiriEstimatedTimetableSubscriptionRequest and cannot be null");
            }
            else
            {
            ...
            if (topics == null)
            {
                throw new InvalidDataException("topics is a required property for V3SiriEstimatedTimetableSubscriptionRequest and cannot be null");
            }
            else
            {
                this.Topics = topics;
        ...
        {
            return this.Equals(input as V3SiriEstimatedTimetableSubscriptionRequest);
        }

        /// <summary>
        /// Returns true if V3SiriEstimatedTimetableSubscriptionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of V3SiriEstimatedTimetableSubscriptionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SiriEstimatedTimetableSubscriptionRequest input)
        {
            if (input == null)
                return false;
