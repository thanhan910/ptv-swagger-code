...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SiriLineRef :  IEquatable<V3SiriLineRef>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V3SiriLineRef" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3SiriLineRef() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3SiriLineRef" /> class.
        /// </summary>
        ...
        public V3SiriLineRef(string lineRef = default(string), DirectionRefEnum? directionRef = default(DirectionRefEnum?))
        {
            // to ensure "lineRef" is required (not null)
            if (lineRef == null)
            {
                throw new InvalidDataException("lineRef is a required property for V3SiriLineRef and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as V3SiriLineRef);
        }

        /// <summary>
        /// Returns true if V3SiriLineRef instances are equal
        /// </summary>
        /// <param name="input">Instance of V3SiriLineRef to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SiriLineRef input)
        {
            if (input == null)
                return false;
