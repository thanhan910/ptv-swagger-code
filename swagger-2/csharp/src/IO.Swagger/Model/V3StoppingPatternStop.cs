...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StoppingPatternStop :  IEquatable<V3StoppingPatternStop>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3StoppingPatternStop" /> class.
        /// </summary>
        /// <param name="stopTicket">Stop ticket information.</param>
        ...
        public V3StoppingPatternStop(V3StopTicket stopTicket = default(V3StopTicket), float? stopDistance = default(float?), string stopSuburb = default(string), string stopName = default(string), int? stopId = default(int?), int? routeType = default(int?), float? stopLatitude = default(float?), float? stopLongitude = default(float?), string stopLandmark = default(string), int? stopSequence = default(int?))
        {
        ...
        /// </summary>
        /// <value>Stop ticket information</value>
        ...
        {
            return this.Equals(input as V3StoppingPatternStop);
        }

        /// <summary>
        /// Returns true if V3StoppingPatternStop instances are equal
        /// </summary>
        /// <param name="input">Instance of V3StoppingPatternStop to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StoppingPatternStop input)
        {
            if (input == null)
                return false;
