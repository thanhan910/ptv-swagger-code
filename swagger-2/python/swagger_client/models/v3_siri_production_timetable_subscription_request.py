...
class V3SiriProductionTimetableSubscriptionRequest(object):
    ...
    def __init__(self, start_time=None, end_time=None, subscriber_ref=None, subscription_ref=None, siri_format=None, siri_version=None, consumer_address=None, initial_termination_time=None, topics=None, _configuration=None):  # noqa: E501
