...
class V3SiriEstimatedTimetableSubscriptionRequest(object):
    ...
    def __init__(self, preview_interval=None, subscriber_ref=None, subscription_ref=None, siri_format=None, siri_version=None, consumer_address=None, initial_termination_time=None, topics=None, _configuration=None):  # noqa: E501
        """V3SiriEstimatedTimetableSubscriptionRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def preview_interval(self):
        """Gets the preview_interval of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501

        Siri Preview Interval  # noqa: E501

        :return: The preview_interval of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def preview_interval(self, preview_interval):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and preview_interval is None:
    ...
    def subscriber_ref(self):
        """Gets the subscriber_ref of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501

        Siri Subscriber Ref  # noqa: E501

        :return: The subscriber_ref of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def subscriber_ref(self, subscriber_ref):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and subscriber_ref is None:
    ...
    def subscription_ref(self):
        """Gets the subscription_ref of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501

        Siri Subscription Ref - Unique to a Subscriber Ref  # noqa: E501

        :return: The subscription_ref of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_ref(self, subscription_ref):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and subscription_ref is None:
    ...
    def siri_format(self):
        """Gets the siri_format of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501

        Siri Message Format 'xml' or 'json'  # noqa: E501

        :return: The siri_format of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def siri_format(self, siri_format):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and siri_format is None:
            raise ValueError("Invalid value for `siri_format`, must not be `None`")  # noqa: E501
        allowed_values = [0, 1]  # noqa: E501
        if (self._configuration.client_side_validation and
                siri_format not in allowed_values):
            raise ValueError(
    ...
    def siri_version(self):
        """Gets the siri_version of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501

        Siri Message Version '1.3' or '2.0'  # noqa: E501

        :return: The siri_version of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def siri_version(self, siri_version):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and siri_version is None:
            raise ValueError("Invalid value for `siri_version`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                siri_version is not None and not re.search(r'1.3|2.0', siri_version)):  # noqa: E501
            raise ValueError(r"Invalid value for `siri_version`, must be a follow pattern or equal to `/1.3|2.0/`")  # noqa: E501

        self._siri_version = siri_version

    @property
    def consumer_address(self):
        """Gets the consumer_address of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501

        Siri Consumer Address - Baseline and Updates will be sent to this address  # noqa: E501

        :return: The consumer_address of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def consumer_address(self, consumer_address):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and consumer_address is None:
    ...
    def initial_termination_time(self):
        """Gets the initial_termination_time of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501

        Siri Initial Termination Time - Expiry of the subscription  # noqa: E501

        :return: The initial_termination_time of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def initial_termination_time(self, initial_termination_time):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and initial_termination_time is None:
    ...
    @property
    def topics(self):
        """Gets the topics of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501


        :return: The topics of this V3SiriEstimatedTimetableSubscriptionRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V3SiriEstimatedTimetableSubscriptionRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V3SiriEstimatedTimetableSubscriptionRequest):
            return False
