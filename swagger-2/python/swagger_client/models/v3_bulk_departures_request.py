...
class V3BulkDeparturesRequest(object):
    ...
    def __init__(self, requests=None, date_utc=None, look_backwards=None, include_cancelled=None, include_geopath=None, expand=None, _configuration=None):  # noqa: E501
