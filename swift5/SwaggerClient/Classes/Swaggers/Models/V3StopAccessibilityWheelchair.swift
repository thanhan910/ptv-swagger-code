...
public struct V3StopAccessibilityWheelchair: Codable {
    ...
    public init(accessibleRamp: Bool? = nil, parking: Bool? = nil, telephone: Bool? = nil, toilet: Bool? = nil, lowTicketCounter: Bool? = nil, manouvering: Bool? = nil, raisedPlatform: Bool? = nil, ramp: Bool? = nil, secondaryPath: Bool? = nil, raisedPlatformShelther: Bool? = nil, steepRamp: Bool? = nil) {
