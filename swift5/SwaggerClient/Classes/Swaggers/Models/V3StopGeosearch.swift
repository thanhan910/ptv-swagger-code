...
public struct V3StopGeosearch: Codable {
    ...
    public init(disruptionIds: [Int64]? = nil, stopDistance: Float? = nil, stopSuburb: String? = nil, stopName: String? = nil, stopId: Int? = nil, routeType: Int? = nil, routes: [Any]? = nil, stopLatitude: Float? = nil, stopLongitude: Float? = nil, stopLandmark: String? = nil, stopSequence: Int? = nil) {
