...
public struct V3StopAccessibility: Codable {
    ...
    public init(lighting: Bool? = nil, platformNumber: Int? = nil, audioCustomerInformation: Bool? = nil, escalator: Bool? = nil, hearingLoop: Bool? = nil, lift: Bool? = nil, stairs: Bool? = nil, stopAccessible: Bool? = nil, tactileGroundSurfaceIndicator: Bool? = nil, waitingRoom: Bool? = nil, wheelchair: V3StopAccessibilityWheelchair? = nil) {
