...
public struct V3PatternDeparture: Codable {
    ...
    public init(skippedStops: [V3StopModel]? = nil, stopId: Int? = nil, routeId: Int? = nil, runId: Int? = nil, runRef: String? = nil, directionId: Int? = nil, disruptionIds: [Int64]? = nil, scheduledDepartureUtc: Date? = nil, estimatedDepartureUtc: Date? = nil, atPlatform: Bool? = nil, platformNumber: String? = nil, flags: String? = nil, departureSequence: Int? = nil) {
    ...
    public enum CodingKeys: String, CodingKey { 
        case skippedStops = "skipped_stops"
        case stopId = "stop_id"
