...
public struct V3StoppingPatternStop: Codable {
    ...
    public init(stopTicket: V3StopTicket? = nil, stopDistance: Float? = nil, stopSuburb: String? = nil, stopName: String? = nil, stopId: Int? = nil, routeType: Int? = nil, stopLatitude: Float? = nil, stopLongitude: Float? = nil, stopLandmark: String? = nil, stopSequence: Int? = nil) {
