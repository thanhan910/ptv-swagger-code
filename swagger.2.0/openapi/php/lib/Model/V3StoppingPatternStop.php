...
/**
 * V3StoppingPatternStop Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V3StoppingPatternStop implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.StoppingPatternStop';
    ...
    protected static $openAPITypes = [
        'stop_ticket' => '\OpenAPI\Client\Model\V3StopTicket',
        'stop_distance' => 'float',
        'stop_suburb' => 'string',
        'stop_name' => 'string',
        'stop_id' => 'int',
    ...
    {
        $this->setIfExists('stop_ticket', $data ?? [], null);
    ...
    */
     ...
     * Gets stop_ticket
     *
     * @return \OpenAPI\Client\Model\V3StopTicket|null
     */
     ...
     * Sets stop_ticket
     *
     * @param \OpenAPI\Client\Model\V3StopTicket|null $stop_ticket stop_ticket
     *
     * @return self
     */
    public function setStopTicket($stop_ticket)
    {
        if (is_null($stop_ticket)) {
            throw new \InvalidArgumentException('non-nullable stop_ticket cannot be null');
        }
