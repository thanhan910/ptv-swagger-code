 ...
 */
class V3RunResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.RunResponse';
    ...
    protected static $openAPITypes = [
        'run' => '\OpenAPI\Client\Model\V3Run',
    ...
    */
     ...
     * Sets run
     *
     * @param \OpenAPI\Client\Model\V3Run|null $run run
     *
     * @return self
     */
