...
/**
 * V3DisruptionStop Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V3DisruptionStop implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.DisruptionStop';
    ...
    */
     ...
     * Sets stop_id
     *
     * @param int|null $stop_id stop_id
     *
     * @return self
     */
     ...
     * Sets stop_name
     *
     * @param string|null $stop_name stop_name
     *
     * @return self
     */
