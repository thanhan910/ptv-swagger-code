 ...
 */
class V3SiriSubscriptionTopic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.SiriSubscriptionTopic';
    ...
    */
     ...
     * Sets direction_ref
     *
     * @param int|null $direction_ref Siri DirectionRef  (in, out, up, down, clockwise, counterclockwise, Inbound, Outbound)
     *
     * @return self
     */
