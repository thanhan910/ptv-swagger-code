 ...
 */
class V3StopDepartureRequestRouteDirection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.StopDepartureRequestRouteDirection';
    ...
    */
     ...
     * Sets route_id
     *
     * @param string|null $route_id Identifier of route; values returned by Routes API - v3/routes
     *
     * @return self
     */
     ...
     * Sets direction_id
     *
     * @param int|null $direction_id Direction of travel identifier; values returned by Directions API - v3/directions
     *
     * @return self
     */
