...
namespace Ptv.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "V3.SiriReferenceDataMappingsResponse")]
    public partial class V3SiriReferenceDataMappingsResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as LineRefs should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeLineRefs()
        {
            return false;
        }
        /// <summary>
