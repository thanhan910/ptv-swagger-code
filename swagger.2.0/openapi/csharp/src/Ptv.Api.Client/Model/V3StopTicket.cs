...
namespace Ptv.Api.Client.Model
{
    ...
    /// V3StopTicket
    /// </summary>
    [DataContract(Name = "V3.StopTicket")]
    public partial class V3StopTicket : IValidatableObject
    {
        /// <summary>
        ...
        [DataMember(Name = "is_free_fare_zone", EmitDefaultValue = true)]
        public bool IsFreeFareZone { get; set; }

        /// <summary>
        /// Gets or Sets TicketMachine
        /// </summary>
        [DataMember(Name = "ticket_machine", EmitDefaultValue = true)]
        public bool TicketMachine { get; set; }

        /// <summary>
        /// Gets or Sets TicketChecks
        /// </summary>
        [DataMember(Name = "ticket_checks", EmitDefaultValue = true)]
        public bool TicketChecks { get; set; }

        /// <summary>
        /// Gets or Sets VlineReservation
        /// </summary>
        [DataMember(Name = "vline_reservation", EmitDefaultValue = true)]
