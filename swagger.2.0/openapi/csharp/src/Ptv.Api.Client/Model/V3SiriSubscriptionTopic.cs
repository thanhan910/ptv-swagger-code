...
namespace Ptv.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "V3.SiriSubscriptionTopic")]
    public partial class V3SiriSubscriptionTopic : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Route Type eg. 0 (Train) 1 (Tram) 2 (Bus) 3 (Vline) 4 (NightRider)</value>
        [DataMember(Name = "route_type", IsRequired = true, EmitDefaultValue = true)]
        ...
        public V3SiriSubscriptionTopic(string lineRef = default(string), DirectionRefEnum? directionRef = default(DirectionRefEnum?), RouteTypeEnum routeType = default(RouteTypeEnum))
        {
            ...
            if (lineRef == null)
            {
                throw new ArgumentNullException("lineRef is a required property for V3SiriSubscriptionTopic and cannot be null");
            }
