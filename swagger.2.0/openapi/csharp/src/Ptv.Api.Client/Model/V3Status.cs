...
namespace Ptv.Api.Client.Model
{
    ...
    /// V3Status
    /// </summary>
    [DataContract(Name = "V3.Status")]
    public partial class V3Status : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="varVersion">API Version number.</param>
        /// <param name="health">API system health status (0&#x3D;offline, 1&#x3D;online).</param>
        public V3Status(string varVersion = default(string), HealthEnum? health = default(HealthEnum?))
        {
