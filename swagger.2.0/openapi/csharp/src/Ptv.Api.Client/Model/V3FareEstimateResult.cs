...
namespace Ptv.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "V3.FareEstimateResult")]
    public partial class V3FareEstimateResult : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name = "IsEarlyBird", EmitDefaultValue = true)]
        public bool IsEarlyBird { get; set; }

        /// <summary>
        /// Gets or Sets IsJourneyInFreeTramZone
        /// </summary>
        [DataMember(Name = "IsJourneyInFreeTramZone", EmitDefaultValue = true)]
        public bool IsJourneyInFreeTramZone { get; set; }

        /// <summary>
        /// Gets or Sets IsThisWeekendJourney
        /// </summary>
        [DataMember(Name = "IsThisWeekendJourney", EmitDefaultValue = true)]
