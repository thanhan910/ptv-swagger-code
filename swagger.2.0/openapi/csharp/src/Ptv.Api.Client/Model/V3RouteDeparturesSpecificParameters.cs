...
namespace Ptv.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "V3.RouteDeparturesSpecificParameters")]
    public partial class V3RouteDeparturesSpecificParameters : IValidatableObject
    {
        /// <summary>
        /// Defines Expand
        /// </summary>
        ...
        [DataMember(Name = "train_scheduled_timetables", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "scheduled_timetables", EmitDefaultValue = true)]
        ...
        public List<V3RouteDeparturesSpecificParameters.ExpandEnum> Expand { get; set; }
