...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3PatternDepartureTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3PatternDeparture
            //Assert.IsType<V3PatternDeparture>(instance);
        }
