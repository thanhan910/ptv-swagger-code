...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3BulkDeparturesRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3BulkDeparturesRequest
            //Assert.IsType<V3BulkDeparturesRequest>(instance);
        }
