...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3StoppingPatternStopTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3StoppingPatternStop
            //Assert.IsType<V3StoppingPatternStop>(instance);
        }
