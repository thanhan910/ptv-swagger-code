...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3StopGeosearchTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3StopGeosearch
            //Assert.IsType<V3StopGeosearch>(instance);
        }
