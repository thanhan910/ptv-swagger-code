...
namespace Ptv.Api.Client.Test.Model
{
    ...
    /// </remarks>
    public class V3BulkDeparturesStopResponseTests : IDisposable
    {
        ...
        public V3BulkDeparturesStopResponseTests()
        {
        ...
        {
            // TODO uncomment below to test "IsType" V3BulkDeparturesStopResponse
            //Assert.IsType<V3BulkDeparturesStopResponse>(instance);
        }
