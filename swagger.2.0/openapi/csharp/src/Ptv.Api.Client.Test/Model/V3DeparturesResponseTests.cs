...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3DeparturesResponseTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3DeparturesResponse
            //Assert.IsType<V3DeparturesResponse>(instance);
        }
