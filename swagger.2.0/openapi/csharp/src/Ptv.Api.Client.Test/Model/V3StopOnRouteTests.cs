...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3StopOnRouteTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3StopOnRoute
            //Assert.IsType<V3StopOnRoute>(instance);
        }
