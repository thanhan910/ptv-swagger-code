...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3VehicleDescriptorTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3VehicleDescriptor
            //Assert.IsType<V3VehicleDescriptor>(instance);
        }
