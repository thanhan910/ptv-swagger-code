...
namespace Ptv.Api.Client.Test.Model
{
    ...
    /// </remarks>
    public class V3DeparturesSpecificParametersTests : IDisposable
    {
        ...
        public V3DeparturesSpecificParametersTests()
        {
        ...
        {
            // TODO uncomment below to test "IsType" V3DeparturesSpecificParameters
            //Assert.IsType<V3DeparturesSpecificParameters>(instance);
        }
