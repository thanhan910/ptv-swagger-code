...
namespace Ptv.Api.Client.Test.Model
{
    ...
    /// </remarks>
    public class V3DeparturesBroadParametersTests : IDisposable
    {
        ...
        public V3DeparturesBroadParametersTests()
        {
        ...
        {
            // TODO uncomment below to test "IsType" V3DeparturesBroadParameters
            //Assert.IsType<V3DeparturesBroadParameters>(instance);
        }
