...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3ResultOutletTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3ResultOutlet
            //Assert.IsType<V3ResultOutlet>(instance);
        }
