...
/**
 * Check if a given object implements the V3Direction interface.
 */
export function instanceOfV3Direction(value: object): boolean {
    return true;
}

export function V3DirectionFromJSON(json: any): V3Direction {
    return V3DirectionFromJSONTyped(json, false);
}

export function V3DirectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): V3Direction {
    if (json == null) {
        return json;
    }
    return {
...
export function V3DirectionToJSON(value?: V3Direction | null): any {
    if (value == null) {
        return value;
    }
    return {
