...
/**
 * Check if a given object implements the V3OutletGeolocation interface.
 */
export function instanceOfV3OutletGeolocation(value: object): boolean {
    return true;
}

export function V3OutletGeolocationFromJSON(json: any): V3OutletGeolocation {
    return V3OutletGeolocationFromJSONTyped(json, false);
}

export function V3OutletGeolocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): V3OutletGeolocation {
    if (json == null) {
        return json;
    }
    return {
        
        'outletDistance': json['outlet_distance'] == null ? undefined : json['outlet_distance'],
...
export function V3OutletGeolocationToJSON(value?: V3OutletGeolocation | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'outlet_distance': value['outletDistance'],
