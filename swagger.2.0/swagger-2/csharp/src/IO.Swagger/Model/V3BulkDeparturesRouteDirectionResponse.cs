...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3BulkDeparturesRouteDirectionResponse :  IEquatable<V3BulkDeparturesRouteDirectionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3BulkDeparturesRouteDirectionResponse" /> class.
        /// </summary>
        ...
        public V3BulkDeparturesRouteDirectionResponse(string routeId = default(string), int? directionId = default(int?), string directionName = default(string))
        {
        ...
        {
            return this.Equals(input as V3BulkDeparturesRouteDirectionResponse);
        }

        /// <summary>
        /// Returns true if V3BulkDeparturesRouteDirectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3BulkDeparturesRouteDirectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3BulkDeparturesRouteDirectionResponse input)
        {
            if (input == null)
                return false;
