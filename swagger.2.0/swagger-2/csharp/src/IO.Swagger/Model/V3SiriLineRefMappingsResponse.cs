...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SiriLineRefMappingsResponse :  IEquatable<V3SiriLineRefMappingsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3SiriLineRefMappingsResponse" /> class.
        /// </summary>
        /// <param name="lineRefs">lineRefs.</param>
        /// <param name="status">API Status / Metadata.</param>
        public V3SiriLineRefMappingsResponse(Dictionary<string, V3SiriLineRefDirectionRefsDictionary> lineRefs = default(Dictionary<string, V3SiriLineRefDirectionRefsDictionary>), V3Status status = default(V3Status))
        {
        ...
        {
            return this.Equals(input as V3SiriLineRefMappingsResponse);
        }

        /// <summary>
        /// Returns true if V3SiriLineRefMappingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3SiriLineRefMappingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SiriLineRefMappingsResponse input)
        {
            if (input == null)
                return false;
