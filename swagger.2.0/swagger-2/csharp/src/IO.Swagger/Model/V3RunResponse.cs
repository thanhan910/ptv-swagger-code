...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3RunResponse :  IEquatable<V3RunResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public V3RunResponse(V3Run run = default(V3Run), V3Status status = default(V3Status))
        {
            this.Run = run;
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as V3RunResponse);
        }

        /// <summary>
        /// Returns true if V3RunResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3RunResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3RunResponse input)
        {
            if (input == null)
                return false;
