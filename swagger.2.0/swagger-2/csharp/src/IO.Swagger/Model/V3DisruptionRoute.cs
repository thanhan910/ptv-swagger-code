...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3DisruptionRoute :  IEquatable<V3DisruptionRoute>, IValidatableObject
    {
        /// <summary>
        ...
        public V3DisruptionRoute(int? routeType = default(int?), int? routeId = default(int?), string routeName = default(string), string routeNumber = default(string), string routeGtfsId = default(string), V3DisruptionDirection direction = default(V3DisruptionDirection))
        {
        ...
        {
            return this.Equals(input as V3DisruptionRoute);
        }

        /// <summary>
        /// Returns true if V3DisruptionRoute instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DisruptionRoute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DisruptionRoute input)
        {
            if (input == null)
                return false;
