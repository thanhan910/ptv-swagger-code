...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SiriDownstreamSubscriptionTopic :  IEquatable<V3SiriDownstreamSubscriptionTopic>, IValidatableObject
    {
        /// <summary>
        /// Defines DirectionRef
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V3SiriDownstreamSubscriptionTopic" /> class.
        /// </summary>
        /// <param name="lineRef">lineRef.</param>
        /// <param name="directionRef">directionRef.</param>
        /// <param name="routeType">routeType.</param>
        public V3SiriDownstreamSubscriptionTopic(string lineRef = default(string), DirectionRefEnum? directionRef = default(DirectionRefEnum?), RouteTypeEnum? routeType = default(RouteTypeEnum?))
        {
        ...
        {
            return this.Equals(input as V3SiriDownstreamSubscriptionTopic);
        }

        /// <summary>
        /// Returns true if V3SiriDownstreamSubscriptionTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of V3SiriDownstreamSubscriptionTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SiriDownstreamSubscriptionTopic input)
        {
            if (input == null)
                return false;
