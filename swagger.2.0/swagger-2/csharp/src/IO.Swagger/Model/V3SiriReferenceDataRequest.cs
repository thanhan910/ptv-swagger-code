...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3SiriReferenceDataRequest :  IEquatable<V3SiriReferenceDataRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3SiriReferenceDataRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V3SiriReferenceDataRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V3SiriReferenceDataRequest" /> class.
        /// </summary>
        /// <param name="lineRefs">lineRefs (required).</param>
        /// <param name="stopPointRefs">Siri StopPointRef.</param>
        ...
        public V3SiriReferenceDataRequest(List<V3SiriLineRefDirectionRefStopPointRef> lineRefs = default(List<V3SiriLineRefDirectionRefStopPointRef>), List<int?> stopPointRefs = default(List<int?>), DateTime? dateUtc = default(DateTime?), string mappingVersion = default(string))
        {
            // to ensure "lineRefs" is required (not null)
            if (lineRefs == null)
            {
                throw new InvalidDataException("lineRefs is a required property for V3SiriReferenceDataRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("mappingVersion is a required property for V3SiriReferenceDataRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as V3SiriReferenceDataRequest);
        }

        /// <summary>
        /// Returns true if V3SiriReferenceDataRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of V3SiriReferenceDataRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3SiriReferenceDataRequest input)
        {
            if (input == null)
                return false;
