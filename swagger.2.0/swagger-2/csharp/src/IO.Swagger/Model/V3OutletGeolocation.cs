...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3OutletGeolocation :  IEquatable<V3OutletGeolocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3OutletGeolocation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as V3OutletGeolocation);
        }

        /// <summary>
        /// Returns true if V3OutletGeolocation instances are equal
        /// </summary>
        /// <param name="input">Instance of V3OutletGeolocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3OutletGeolocation input)
        {
            if (input == null)
                return false;
