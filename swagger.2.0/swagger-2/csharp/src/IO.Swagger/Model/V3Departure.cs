...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3Departure :  IEquatable<V3Departure>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as V3Departure);
        }

        /// <summary>
        /// Returns true if V3Departure instances are equal
        /// </summary>
        /// <param name="input">Instance of V3Departure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3Departure input)
        {
            if (input == null)
                return false;
