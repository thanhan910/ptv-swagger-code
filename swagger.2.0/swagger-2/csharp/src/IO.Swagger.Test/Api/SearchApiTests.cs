...
namespace IO.Swagger.Test
{
    ...
    public class SearchApiTests
    {
        ...
        public void SearchSearchTest()
        {
            ...
            //var response = instance.SearchSearch(searchTerm, routeTypes, latitude, longitude, maxDistance, includeAddresses, includeOutlets, matchStopBySuburb, matchRouteBySuburb, matchStopByGtfsStopId, token, devid, signature);
            //Assert.IsInstanceOf<V3SearchResult> (response, "response is V3SearchResult");
        }
