...
class V3Run implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Swagger\Client\Model\V3VehiclePosition $vehicle_position Position of the trip/service run. Available for some Bus, Nightrider and Train runs. May be null.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\V3VehicleDescriptor $vehicle_descriptor Descriptor of the trip/service run. Only available for some runs. May be null.
     *
     * @return $this
     */
