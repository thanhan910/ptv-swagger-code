 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V3SiriEstimatedTimetableSubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V3.SiriEstimatedTimetableSubscriptionRequest';
    ...
    public function setSiriVersion($siri_version)
    {
        ...
        if ((!preg_match("/1.3|2.0/", $siri_version))) {
