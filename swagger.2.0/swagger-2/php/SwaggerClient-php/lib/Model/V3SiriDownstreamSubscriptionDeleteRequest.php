 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V3SiriDownstreamSubscriptionDeleteRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V3.SiriDownstreamSubscriptionDeleteRequest';
     ...
     *
     * @param string[] $subscription_ref Siri Subscription Reference(s) - Unique to a Subscriber Ref.  If `null`, then all subscriptions will be terminated for the referenced Subscriber.
     *
     * @return $this
     */
