...
class V3Disruption(object):
    ...
    def __init__(self, disruption_id=None, title=None, url=None, description=None, disruption_status=None, disruption_type=None, published_on=None, last_updated=None, from_date=None, to_date=None, routes=None, stops=None, colour=None, display_on_board=None, display_status=None, _configuration=None):  # noqa: E501
