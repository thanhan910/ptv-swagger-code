...
class V3FareEstimateResult(object):
    ...
    def __init__(self, is_early_bird=None, is_journey_in_free_tram_zone=None, is_this_weekend_journey=None, zone_info=None, passenger_fares=None, _configuration=None):  # noqa: E501
