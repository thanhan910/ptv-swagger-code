...
class V3Disruptions(object):
    ...
    def __init__(self, general=None, metro_train=None, metro_tram=None, metro_bus=None, regional_train=None, regional_coach=None, regional_bus=None, school_bus=None, telebus=None, night_bus=None, ferry=None, interstate_train=None, skybus=None, taxi=None, _configuration=None):  # noqa: E501
