...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3DeparturesResponse :  IEquatable<V3DeparturesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public V3DeparturesResponse(List<V3Departure> departures = default(List<V3Departure>), Dictionary<string, V3StopModel> stops = default(Dictionary<string, V3StopModel>), Dictionary<string, Object> routes = default(Dictionary<string, Object>), Dictionary<string, V3Run> runs = default(Dictionary<string, V3Run>), Dictionary<string, V3Direction> directions = default(Dictionary<string, V3Direction>), Dictionary<string, V3Disruption> disruptions = default(Dictionary<string, V3Disruption>), V3Status status = default(V3Status))
        {
        ...
        {
            return this.Equals(input as V3DeparturesResponse);
        }

        /// <summary>
        /// Returns true if V3DeparturesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DeparturesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DeparturesResponse input)
        {
            if (input == null)
                return false;
