...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3StopModel :  IEquatable<V3StopModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3StopModel" /> class.
        /// </summary>
        ...
        public V3StopModel(float? stopDistance = default(float?), string stopSuburb = default(string), string stopName = default(string), int? stopId = default(int?), int? routeType = default(int?), float? stopLatitude = default(float?), float? stopLongitude = default(float?), string stopLandmark = default(string), int? stopSequence = default(int?))
        {
        ...
        {
            return this.Equals(input as V3StopModel);
        }

        /// <summary>
        /// Returns true if V3StopModel instances are equal
        /// </summary>
        /// <param name="input">Instance of V3StopModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopModel input)
        {
            if (input == null)
                return false;
