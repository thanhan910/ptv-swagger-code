...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3DisruptionDirection :  IEquatable<V3DisruptionDirection>, IValidatableObject
    {
        /// <summary>
        ...
        public V3DisruptionDirection(int? routeDirectionId = default(int?), int? directionId = default(int?), string directionName = default(string), string serviceTime = default(string))
        {
        ...
        {
            return this.Equals(input as V3DisruptionDirection);
        }

        /// <summary>
        /// Returns true if V3DisruptionDirection instances are equal
        /// </summary>
        /// <param name="input">Instance of V3DisruptionDirection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DisruptionDirection input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.RouteDirectionId == input.RouteDirectionId ||
                    (this.RouteDirectionId != null &&
                    this.RouteDirectionId.Equals(input.RouteDirectionId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RouteDirectionId != null)
                    hashCode = hashCode * 59 + this.RouteDirectionId.GetHashCode();
