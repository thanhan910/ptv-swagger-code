...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3ZoneInfo :  IEquatable<V3ZoneInfo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as V3ZoneInfo);
        }

        /// <summary>
        /// Returns true if V3ZoneInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of V3ZoneInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3ZoneInfo input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.MinZone == input.MinZone ||
                    (this.MinZone != null &&
                    this.MinZone.Equals(input.MinZone))
                ) && 
                (
                    this.MaxZone == input.MaxZone ||
                    (this.MaxZone != null &&
                    this.MaxZone.Equals(input.MaxZone))
                ) && 
                (
                    this.UniqueZones == input.UniqueZones ||
                    this.UniqueZones != null &&
                    input.UniqueZones != null &&
                    this.UniqueZones.SequenceEqual(input.UniqueZones)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MinZone != null)
                    hashCode = hashCode * 59 + this.MinZone.GetHashCode();
                if (this.MaxZone != null)
                    hashCode = hashCode * 59 + this.MaxZone.GetHashCode();
                if (this.UniqueZones != null)
                    hashCode = hashCode * 59 + this.UniqueZones.GetHashCode();
                return hashCode;
            }
        }
