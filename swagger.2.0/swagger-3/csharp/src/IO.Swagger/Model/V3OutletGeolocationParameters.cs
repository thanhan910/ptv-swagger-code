...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3OutletGeolocationParameters :  IEquatable<V3OutletGeolocationParameters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3OutletGeolocationParameters" /> class.
        /// </summary>
        ...
        public V3OutletGeolocationParameters(double? maxDistance = default(double?), int? maxResults = default(int?))
        {
        ...
        {
            return this.Equals(input as V3OutletGeolocationParameters);
        }

        /// <summary>
        /// Returns true if V3OutletGeolocationParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of V3OutletGeolocationParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3OutletGeolocationParameters input)
        {
            if (input == null)
                return false;
