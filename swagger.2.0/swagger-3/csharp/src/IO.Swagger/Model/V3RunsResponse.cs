...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3RunsResponse :  IEquatable<V3RunsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public V3RunsResponse(List<V3Run> runs = default(List<V3Run>), V3Status status = default(V3Status))
        {
            this.Runs = runs;
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as V3RunsResponse);
        }

        /// <summary>
        /// Returns true if V3RunsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3RunsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3RunsResponse input)
        {
            if (input == null)
                return false;
