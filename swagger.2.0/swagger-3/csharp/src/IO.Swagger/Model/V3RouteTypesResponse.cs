...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V3RouteTypesResponse :  IEquatable<V3RouteTypesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public V3RouteTypesResponse(List<V3RouteType> routeTypes = default(List<V3RouteType>), V3Status status = default(V3Status))
        {
        ...
        {
            return this.Equals(input as V3RouteTypesResponse);
        }

        /// <summary>
        /// Returns true if V3RouteTypesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of V3RouteTypesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3RouteTypesResponse input)
        {
            if (input == null)
                return false;
