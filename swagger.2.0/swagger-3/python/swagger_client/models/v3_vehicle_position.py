...
class V3VehiclePosition(object):
    ...
    def __init__(self, latitude=None, longitude=None, easting=None, northing=None, direction=None, bearing=None, supplier=None, datetime_utc=None, expiry_time=None):  # noqa: E501
