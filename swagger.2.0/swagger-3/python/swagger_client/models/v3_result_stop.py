...
class V3ResultStop(object):
    ...
    def __init__(self, stop_distance=None, stop_suburb=None, route_type=None, routes=None, stop_latitude=None, stop_longitude=None, stop_sequence=None, stop_id=None, stop_name=None, stop_landmark=None):  # noqa: E501
