...
class V3SiriEstimatedTimetableSubscriptionRequest(object):
    ...
    def __init__(self, preview_interval=None, subscriber_ref=None, subscription_ref=None, siri_format=None, siri_version=None, consumer_address=None, initial_termination_time=None, topics=None):  # noqa: E501
