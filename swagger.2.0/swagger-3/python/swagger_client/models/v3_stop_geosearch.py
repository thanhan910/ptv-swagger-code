...
class V3StopGeosearch(object):
    ...
    def __init__(self, disruption_ids=None, stop_distance=None, stop_suburb=None, stop_name=None, stop_id=None, route_type=None, routes=None, stop_latitude=None, stop_longitude=None, stop_landmark=None, stop_sequence=None):  # noqa: E501
