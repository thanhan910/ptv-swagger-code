...
/**
 * V3OutletGeolocationParameters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V3OutletGeolocationParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.OutletGeolocationParameters';
    ...
    */
     ...
     * Sets max_distance
     *
     * @param float|null $max_distance Filter by maximum distance (in metres) from location specified via latitude and longitude parameters (default = 300)
     *
     * @return self
     */
     ...
     * Sets max_results
     *
     * @param int|null $max_results Maximum number of results returned (default = 30)
     *
     * @return self
     */
