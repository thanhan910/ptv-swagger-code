 ...
 */
class V3ResultStop implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.ResultStop';
    ...
    */
     ...
     * Sets routes
     *
     * @param \OpenAPI\Client\Model\V3ResultRoute[]|null $routes List of routes travelling through the stop
     *
     * @return self
     */
