...
/**
 * V3SiriDownstreamSubscriptionDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V3SiriDownstreamSubscriptionDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.SiriDownstreamSubscriptionDeleteRequest';
    ...
    */
     ...
     *
     * @param string[]|null $subscription_ref Siri Subscription Reference(s) - Unique to a Subscriber Ref.  If `null`, then all subscriptions will be terminated for the referenced Subscriber.
     *
     * @return self
     */
