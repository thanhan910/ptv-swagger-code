...
/**
 * V3DirectionWithDescription Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V3DirectionWithDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.DirectionWithDescription';
    ...
    protected static array $openAPINullables = [
        'route_direction_description' => false,
        'direction_id' => false,
    ...
    protected static $setters = [
        'route_direction_description' => 'setRouteDirectionDescription',
    ...
    protected static $getters = [
        'route_direction_description' => 'getRouteDirectionDescription',
    ...
    {
        $this->setIfExists('route_direction_description', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets route_direction_description
     *
     * @return string|null
     */
    public function getRouteDirectionDescription()
    {
        return $this->container['route_direction_description'];
    }

    /**
     * Sets route_direction_description
     *
     * @param string|null $route_direction_description route_direction_description
     *
     * @return self
     */
    public function setRouteDirectionDescription($route_direction_description)
    {
        if (is_null($route_direction_description)) {
            throw new \InvalidArgumentException('non-nullable route_direction_description cannot be null');
        }
        $this->container['route_direction_description'] = $route_direction_description;
