    ...
    def make_instance(self, include_optional) -> V3SiriLineRefMappingsResponse:
        ...
        if include_optional:
            return V3SiriLineRefMappingsResponse(
                mapping_version = '',
                line_refs = {
                    'key' : ptv_api_client.models.v3/siri_line_ref_direction_refs_dictionary.V3.SiriLineRefDirectionRefsDictionary(
                        direction_refs = {
                            'key' : [
                                ptv_api_client.models.v3/siri_reference_data_detail.V3.SiriReferenceDataDetail(
                                    route_id = 56, 
                                    route_number_short = '', 
                                    direction_id = 56, 
