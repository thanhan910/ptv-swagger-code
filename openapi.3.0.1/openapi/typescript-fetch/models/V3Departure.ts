...
/**
 * Check if a given object implements the V3Departure interface.
 */
export function instanceOfV3Departure(value: object): boolean {
    return true;
}

export function V3DepartureFromJSON(json: any): V3Departure {
    return V3DepartureFromJSONTyped(json, false);
}

export function V3DepartureFromJSONTyped(json: any, ignoreDiscriminator: boolean): V3Departure {
    if (json == null) {
        return json;
    }
    return {
...
export function V3DepartureToJSON(value?: Omit<V3Departure, 'run_id'> | null): any {
    if (value == null) {
        return value;
    }
    return {
