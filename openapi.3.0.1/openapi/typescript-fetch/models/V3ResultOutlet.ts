...
/**
 * Check if a given object implements the V3ResultOutlet interface.
 */
export function instanceOfV3ResultOutlet(value: object): boolean {
    return true;
}

export function V3ResultOutletFromJSON(json: any): V3ResultOutlet {
    return V3ResultOutletFromJSONTyped(json, false);
}

export function V3ResultOutletFromJSONTyped(json: any, ignoreDiscriminator: boolean): V3ResultOutlet {
    if (json == null) {
        return json;
    }
    return {
...
export function V3ResultOutletToJSON(value?: V3ResultOutlet | null): any {
    if (value == null) {
        return value;
    }
    return {
