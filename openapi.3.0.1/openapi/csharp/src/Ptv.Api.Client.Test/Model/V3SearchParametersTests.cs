...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3SearchParametersTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3SearchParameters
            //Assert.IsType<V3SearchParameters>(instance);
        }
