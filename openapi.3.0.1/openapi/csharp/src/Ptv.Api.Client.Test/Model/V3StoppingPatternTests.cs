...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3StoppingPatternTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3StoppingPattern
            //Assert.IsType<V3StoppingPattern>(instance);
        }
