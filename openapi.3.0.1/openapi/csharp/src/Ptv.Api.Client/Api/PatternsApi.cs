...
namespace Ptv.Api.Client.Api
{
    ...
    public interface IPatternsApiSync : IApiAccessor
    {
        ...
        /// <param name="includeSkippedStops">Include any skipped stops in a stopping pattern. Defaults to false. (optional)</param>
        ...
        V3StoppingPattern PatternsGetPatternByRun(string runRef, int routeType, List<string> expand, int? stopId = default(int?), DateTime? dateUtc = default(DateTime?), bool? includeSkippedStops = default(bool?), bool? includeGeopath = default(bool?), string? token = default(string?), string? devid = default(string?), string? signature = default(string?), int operationIndex = 0);
        ...
        ApiResponse<V3StoppingPattern> PatternsGetPatternByRunWithHttpInfo(string runRef, int routeType, List<string> expand, int? stopId = default(int?), DateTime? dateUtc = default(DateTime?), bool? includeSkippedStops = default(bool?), bool? includeGeopath = default(bool?), string? token = default(string?), string? devid = default(string?), string? signature = default(string?), int operationIndex = 0);
    ...
    public interface IPatternsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<V3StoppingPattern>> PatternsGetPatternByRunWithHttpInfoAsync(string runRef, int routeType, List<string> expand, int? stopId = default(int?), DateTime? dateUtc = default(DateTime?), bool? includeSkippedStops = default(bool?), bool? includeGeopath = default(bool?), string? token = default(string?), string? devid = default(string?), string? signature = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PatternsApi : IPatternsApi
    {
        ...
        /// <returns></returns>
        public PatternsApi(Ptv.Api.Client.Client.Configuration configuration)
        {
        ...
        public PatternsApi(Ptv.Api.Client.Client.ISynchronousClient client, Ptv.Api.Client.Client.IAsynchronousClient asyncClient, Ptv.Api.Client.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>V3StoppingPattern</returns>
        public V3StoppingPattern PatternsGetPatternByRun(string runRef, int routeType, List<string> expand, int? stopId = default(int?), DateTime? dateUtc = default(DateTime?), bool? includeSkippedStops = default(bool?), bool? includeGeopath = default(bool?), string? token = default(string?), string? devid = default(string?), string? signature = default(string?), int operationIndex = 0)
        {
            Ptv.Api.Client.Client.ApiResponse<V3StoppingPattern> localVarResponse = PatternsGetPatternByRunWithHttpInfo(runRef, routeType, expand, stopId, dateUtc, includeSkippedStops, includeGeopath, token, devid, signature);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of V3StoppingPattern</returns>
        public Ptv.Api.Client.Client.ApiResponse<V3StoppingPattern> PatternsGetPatternByRunWithHttpInfo(string runRef, int routeType, List<string> expand, int? stopId = default(int?), DateTime? dateUtc = default(DateTime?), bool? includeSkippedStops = default(bool?), bool? includeGeopath = default(bool?), string? token = default(string?), string? devid = default(string?), string? signature = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'runRef' is set
            if (runRef == null)
            {
                throw new Ptv.Api.Client.Client.ApiException(400, "Missing required parameter 'runRef' when calling PatternsApi->PatternsGetPatternByRun");
            }

            // verify the required parameter 'expand' is set
            if (expand == null)
            {
                throw new Ptv.Api.Client.Client.ApiException(400, "Missing required parameter 'expand' when calling PatternsApi->PatternsGetPatternByRun");
            }
            ...
            if (stopId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Ptv.Api.Client.Client.ClientUtils.ParameterToMultiMap("", "stop_id", stopId));
            }
            if (dateUtc != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Ptv.Api.Client.Client.ClientUtils.ParameterToMultiMap("", "include_skipped_stops", includeSkippedStops));
            }
            ...
            localVarRequestOptions.Operation = "PatternsApi.PatternsGetPatternByRun";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<V3StoppingPattern>("/v3/pattern/run/{run_ref}/route_type/{route_type}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatternsGetPatternByRun", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of V3StoppingPattern</returns>
        public async System.Threading.Tasks.Task<V3StoppingPattern> PatternsGetPatternByRunAsync(string runRef, int routeType, List<string> expand, int? stopId = default(int?), DateTime? dateUtc = default(DateTime?), bool? includeSkippedStops = default(bool?), bool? includeGeopath = default(bool?), string? token = default(string?), string? devid = default(string?), string? signature = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Ptv.Api.Client.Client.ApiResponse<V3StoppingPattern> localVarResponse = await PatternsGetPatternByRunWithHttpInfoAsync(runRef, routeType, expand, stopId, dateUtc, includeSkippedStops, includeGeopath, token, devid, signature, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (V3StoppingPattern)</returns>
        public async System.Threading.Tasks.Task<Ptv.Api.Client.Client.ApiResponse<V3StoppingPattern>> PatternsGetPatternByRunWithHttpInfoAsync(string runRef, int routeType, List<string> expand, int? stopId = default(int?), DateTime? dateUtc = default(DateTime?), bool? includeSkippedStops = default(bool?), bool? includeGeopath = default(bool?), string? token = default(string?), string? devid = default(string?), string? signature = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'runRef' is set
            if (runRef == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<V3StoppingPattern>("/v3/pattern/run/{run_ref}/route_type/{route_type}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
