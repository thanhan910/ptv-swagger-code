...
namespace Ptv.Api.Client.Model
{
    ...
    /// V3StopDetails
    /// </summary>
    [DataContract(Name = "V3.StopDetails")]
    public partial class V3StopDetails : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="stopLocation">stopLocation.</param>
        /// <param name="stopAmenities">stopAmenities.</param>
        /// <param name="stopAccessibility">stopAccessibility.</param>
        /// <param name="stopStaffing">stopStaffing.</param>
