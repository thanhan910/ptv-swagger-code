 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V3PatternDeparture implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V3.PatternDeparture';
    ...
    protected static $swaggerTypes = [
        'skipped_stops' => '\Swagger\Client\Model\V3StopModel[]',
        'stop_id' => 'int',
        'route_id' => 'int',
        'run_id' => 'int',
        'run_ref' => 'string',
    ...
    {
        $this->container['skipped_stops'] = isset($data['skipped_stops']) ? $data['skipped_stops'] : null;
     ...
     * Gets skipped_stops
     *
     * @return \Swagger\Client\Model\V3StopModel[]
     */
     ...
     * Sets skipped_stops
     *
     * @param \Swagger\Client\Model\V3StopModel[] $skipped_stops The stops to be skipped following the current departure in order.
     *
     * @return $this
     */
