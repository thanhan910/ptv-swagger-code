...
class PatternsApi
{
     ...
     * @return \Swagger\Client\Model\V3StoppingPattern
     */
    public function patternsGetPatternByRun($run_ref, $route_type, $expand, $stop_id = null, $date_utc = null, $include_skipped_stops = null, $include_geopath = null, $token = null, $devid = null, $signature = null)
    {
        list($response) = $this->patternsGetPatternByRunWithHttpInfo($run_ref, $route_type, $expand, $stop_id, $date_utc, $include_skipped_stops, $include_geopath, $token, $devid, $signature);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\V3StoppingPattern, HTTP status code, HTTP response headers (array of strings)
     */
    public function patternsGetPatternByRunWithHttpInfo($run_ref, $route_type, $expand, $stop_id = null, $date_utc = null, $include_skipped_stops = null, $include_geopath = null, $token = null, $devid = null, $signature = null)
    {
        $returnType = '\Swagger\Client\Model\V3StoppingPattern';
        $request = $this->patternsGetPatternByRunRequest($run_ref, $route_type, $expand, $stop_id, $date_utc, $include_skipped_stops, $include_geopath, $token, $devid, $signature);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\V3StoppingPattern',
     ...
     */
    public function patternsGetPatternByRunAsync($run_ref, $route_type, $expand, $stop_id = null, $date_utc = null, $include_skipped_stops = null, $include_geopath = null, $token = null, $devid = null, $signature = null)
    {
        return $this->patternsGetPatternByRunAsyncWithHttpInfo($run_ref, $route_type, $expand, $stop_id, $date_utc, $include_skipped_stops, $include_geopath, $token, $devid, $signature)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patternsGetPatternByRunAsyncWithHttpInfo($run_ref, $route_type, $expand, $stop_id = null, $date_utc = null, $include_skipped_stops = null, $include_geopath = null, $token = null, $devid = null, $signature = null)
    {
        $returnType = '\Swagger\Client\Model\V3StoppingPattern';
        $request = $this->patternsGetPatternByRunRequest($run_ref, $route_type, $expand, $stop_id, $date_utc, $include_skipped_stops, $include_geopath, $token, $devid, $signature);
     ...
     */
    protected function patternsGetPatternByRunRequest($run_ref, $route_type, $expand, $stop_id = null, $date_utc = null, $include_skipped_stops = null, $include_geopath = null, $token = null, $devid = null, $signature = null)
    {
        ...
        // query params
        if ($stop_id !== null) {
            $queryParams['stop_id'] = ObjectSerializer::toQueryValue($stop_id, 'int32');
        }
        // query params
        if ($date_utc !== null) {
        ...
        // query params
        if ($include_skipped_stops !== null) {
            $queryParams['include_skipped_stops'] = ObjectSerializer::toQueryValue($include_skipped_stops, null);
        }
        // query params
