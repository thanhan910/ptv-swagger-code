...
open class RoutesAPI: APIBase {
     ...
     */
    open class func routesOneOrMoreRoutes(routeTypes: [Int32]? = nil, routeName: String? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3RouteResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "status" : {
     ...
     */
    open class func routesOneOrMoreRoutesWithRequestBuilder(routeTypes: [Int32]? = nil, routeName: String? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3RouteResponse> {
        let path = "/v3/routes"
    ...
    /**
     ...
     - parameter includeGeopath: (query) Indicates kif geopath data will be returned (default &#x3D; false) (optional)
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func routesRouteFromId(routeId: Int32, includeGeopath: Bool? = nil, geopathUtc: Date? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3RouteResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "status" : {
    ...
    "version" : "version"
     ...
     - returns: RequestBuilder<V3RouteResponse> 
     */
    open class func routesRouteFromIdWithRequestBuilder(routeId: Int32, includeGeopath: Bool? = nil, geopathUtc: Date? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3RouteResponse> {
