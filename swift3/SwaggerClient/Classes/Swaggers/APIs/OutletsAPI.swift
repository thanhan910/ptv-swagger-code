...
open class OutletsAPI: APIBase {
     ...
     */
    open class func outletsGetAllOutlets(maxResults: Int32? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3OutletResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "status" : {
     ...
     */
    open class func outletsGetAllOutletsWithRequestBuilder(maxResults: Int32? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3OutletResponse> {
        let path = "/v3/outlets"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func outletsGetOutletsByGeolocation(latitude: Float, longitude: Float, maxDistance: Double? = nil, maxResults: Int32? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3OutletGeolocationResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "status" : {
     ...
     */
    open class func outletsGetOutletsByGeolocationWithRequestBuilder(latitude: Float, longitude: Float, maxDistance: Double? = nil, maxResults: Int32? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3OutletGeolocationResponse> {
