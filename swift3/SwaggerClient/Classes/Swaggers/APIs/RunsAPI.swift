...
open class RunsAPI: APIBase {
    ...
    /**
     ...
     - parameter expand: (query) List of objects to be returned in full (i.e. expanded) - options include: All, VehiclePosition, VehicleDescriptor, or None. Default is None. (optional)
     - parameter dateUtc: (query) Date of the request. (optional - defaults to now) (optional)
     ...
     */
    open class func runsForRoute(routeId: Int32, expand: [String]? = nil, dateUtc: Date? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3RunsResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "status" : {
     ...
     */
    open class func runsForRouteWithRequestBuilder(routeId: Int32, expand: [String]? = nil, dateUtc: Date? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3RunsResponse> {
     ...
     */
    public enum RouteType_runsForRouteAndRouteType: Int32 { 
        case _0 = 0
        case _1 = 1
        case _2 = 2
        case _3 = 3
    ...
    /**
     ...
     - parameter expand: (query) List of objects to be returned in full (i.e. expanded) - options include: All, VehiclePosition, VehicleDescriptor, or None. Default is All. 
     - parameter dateUtc: (query) Date of the request. (optional - defaults to now) (optional)
     - parameter token: (query) Please ignore (optional)
     - parameter devid: (query) Your developer id (optional)
     - parameter signature: (query) Authentication signature for request (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func runsForRouteAndRouteType(routeId: Int32, routeType: RouteType_runsForRouteAndRouteType, expand: [String], dateUtc: Date? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3RunsResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "status" : {
    ...
    "version" : "version"
     ...
     - returns: RequestBuilder<V3RunsResponse> 
     */
    open class func runsForRouteAndRouteTypeWithRequestBuilder(routeId: Int32, routeType: RouteType_runsForRouteAndRouteType, expand: [String], dateUtc: Date? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3RunsResponse> {
    ...
    /**
     ...
     - parameter expand: (query) List of objects to be returned in full (i.e. expanded) - options include: All, VehiclePosition, VehicleDescriptor, or None. Default is None. 
     - parameter dateUtc: (query) Date of the request. (optional - defaults to now) (optional)
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func runsForRun(runRef: String, expand: [String], dateUtc: Date? = nil, includeGeopath: Bool? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3RunsResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "status" : {
     ...
     * enum for parameter routeType
     */
    public enum RouteType_runsForRunAndRouteType: Int32 { 
        case _0 = 0
        case _1 = 1
        case _2 = 2
        case _3 = 3
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func runsForRunAndRouteType(runRef: String, routeType: RouteType_runsForRunAndRouteType, expand: [String], dateUtc: Date? = nil, includeGeopath: Bool? = nil, token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3RunResponse?, _ error: ErrorResponse?) -> Void)) {
