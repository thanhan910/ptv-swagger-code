...
open class RouteTypesAPI: APIBase {
    /**
     ...
     */
    open class func routeTypesGetRouteTypes(token: String? = nil, devid: String? = nil, signature: String? = nil, completion: @escaping ((_ data: V3RouteTypesResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "status" : {
    ...
    open class func routeTypesGetRouteTypesWithRequestBuilder(token: String? = nil, devid: String? = nil, signature: String? = nil) -> RequestBuilder<V3RouteTypesResponse> {
        ...
        let requestBuilder: RequestBuilder<V3RouteTypesResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
