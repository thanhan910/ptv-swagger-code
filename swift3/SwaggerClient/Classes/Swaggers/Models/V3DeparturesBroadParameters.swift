...
open class V3DeparturesBroadParameters: JSONEncodable {
    ...
    public var platformNumbers: [Int32]?
    ...
    open func encodeToJSON() -> Any {
        ...
        nillableDictionary["platform_numbers"] = self.platformNumbers?.encodeToJSON()
