...
open class V3PatternDeparture: JSONEncodable {
    /** The stops to be skipped following the current departure in order. */
    public var skippedStops: [V3StopModel]?
    /** Stop identifier */
    ...
    open func encodeToJSON() -> Any {
        ...
        nillableDictionary["skipped_stops"] = self.skippedStops?.encodeToJSON()
