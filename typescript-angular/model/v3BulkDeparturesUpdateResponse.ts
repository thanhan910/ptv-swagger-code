...
export namespace V3BulkDeparturesUpdateResponse {
    export type RouteDirectionStatusEnum = 0 | 1;
    export const RouteDirectionStatusEnum = {
        NUMBER_0: 0 as RouteDirectionStatusEnum,
        NUMBER_1: 1 as RouteDirectionStatusEnum
    };
}