...
export namespace V3SearchParameters {
    export type RouteTypesEnum = '0' | '1' | '2' | '3' | '4';
    export const RouteTypesEnum = {
        _0: '0' as RouteTypesEnum,
        _1: '1' as RouteTypesEnum,
        _2: '2' as RouteTypesEnum,
        _3: '3' as RouteTypesEnum,
        _4: '4' as RouteTypesEnum
    };
}