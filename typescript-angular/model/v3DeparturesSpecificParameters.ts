...
export namespace V3DeparturesSpecificParameters {
    export type ExpandEnum = 'All' | 'Stop' | 'Route' | 'Run' | 'Direction' | 'Disruption' | 'VehicleDescriptor' | 'VehiclePosition' | 'None';
    export const ExpandEnum = {
        All: 'All' as ExpandEnum,
        Stop: 'Stop' as ExpandEnum,
        Route: 'Route' as ExpandEnum,
        Run: 'Run' as ExpandEnum,
        Direction: 'Direction' as ExpandEnum,
        Disruption: 'Disruption' as ExpandEnum,
        VehicleDescriptor: 'VehicleDescriptor' as ExpandEnum,
        VehiclePosition: 'VehiclePosition' as ExpandEnum,
        None: 'None' as ExpandEnum
    };
}