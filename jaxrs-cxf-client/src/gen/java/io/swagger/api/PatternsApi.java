...
public interface PatternsApi  {
    ...
    @Operation(summary = "View the stopping pattern for a specific trip/service run", tags={  })
    @ApiResponses(value = { 
    ...
    public V3StoppingPattern patternsGetPatternByRun(@PathParam("run_ref") String runRef, @PathParam("route_type") Integer routeType, @QueryParam("expand")List<String> expand, @QueryParam("stop_id")Integer stopId, @QueryParam("date_utc")Date dateUtc, @QueryParam("include_skipped_stops")Boolean includeSkippedStops, @QueryParam("include_geopath")Boolean includeGeopath, @QueryParam("token")String token, @QueryParam("devid")String devid, @QueryParam("signature")String signature);
}
