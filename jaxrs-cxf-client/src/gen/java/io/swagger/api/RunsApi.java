...
public interface RunsApi  {
    ...
    @Operation(summary = "View all trip/service runs for a specific route ID", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View all trip/service runs for a specific route ID and route type", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public V3RunsResponse runsForRouteAndRouteType(@PathParam("route_id") Integer routeId, @PathParam("route_type") Integer routeType, @QueryParam("expand")List<String> expand, @QueryParam("date_utc")Date dateUtc, @QueryParam("token")String token, @QueryParam("devid")String devid, @QueryParam("signature")String signature);
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View all trip/service runs for a specific run_ref", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public V3RunsResponse runsForRun(@PathParam("run_ref") String runRef, @QueryParam("expand")List<String> expand, @QueryParam("date_utc")Date dateUtc, @QueryParam("include_geopath")Boolean includeGeopath, @QueryParam("token")String token, @QueryParam("devid")String devid, @QueryParam("signature")String signature);
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View the trip/service run for a specific run_ref and route type", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public V3RunResponse runsForRunAndRouteType(@PathParam("run_ref") String runRef, @PathParam("route_type") Integer routeType, @QueryParam("expand")List<String> expand, @QueryParam("date_utc")Date dateUtc, @QueryParam("include_geopath")Boolean includeGeopath, @QueryParam("token")String token, @QueryParam("devid")String devid, @QueryParam("signature")String signature);
}
