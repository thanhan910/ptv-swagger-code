...
public interface StopsApi  {
    ...
    @Operation(summary = "View facilities at a specific stop (Metro and V/Line stations only)", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View all stops near a specific location", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View all stops on a specific route", tags={  })
    @ApiResponses(value = { 
