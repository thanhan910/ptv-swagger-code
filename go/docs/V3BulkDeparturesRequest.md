...
------------ | ------------- | ------------- | -------------
**Requests** | [**[]V3StopDepartureRequest**](V3.StopDepartureRequest.md) | Collection of departure requests | [default to null]
...
**Expand** | **[]string** | List objects to be returned in full (i.e. expanded) - options include: all, stop, route, run, direction, disruption, none | [optional] [default to null]
