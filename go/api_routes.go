...
/*
RoutesApiService View route names and numbers for all routes
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RoutesApiRoutesOneOrMoreRoutesOpts - Optional Parameters:
     * @param "RouteTypes" (optional.Interface of []int32) -  Filter by route_type; values returned via RouteTypes API
     * @param "RouteName" (optional.String) -  Filter by name  of route (accepts partial route name matches)
...
type RoutesApiRoutesOneOrMoreRoutesOpts struct {
...
func (a *RoutesApiService) RoutesOneOrMoreRoutes(ctx context.Context, localVarOptionals *RoutesApiRoutesOneOrMoreRoutesOpts) (V3RouteResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue V3RouteResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/routes"
	...
	if localVarOptionals != nil && localVarOptionals.RouteName.IsSet() {
		localVarQueryParams.Add("route_name", parameterToString(localVarOptionals.RouteName.Value(), ""))
	}
...
/*
RoutesApiService View route name and number for specific route ID
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param routeId Identifier of route; values returned by Departures, Directions and Disruptions APIs
 * @param optional nil or *RoutesApiRoutesRouteFromIdOpts - Optional Parameters:
     * @param "IncludeGeopath" (optional.Bool) -  Indicates kif geopath data will be returned (default &#x3D; false)
...
type RoutesApiRoutesRouteFromIdOpts struct {
...
func (a *RoutesApiService) RoutesRouteFromId(ctx context.Context, routeId int32, localVarOptionals *RoutesApiRoutesRouteFromIdOpts) (V3RouteResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/routes/{route_id}"
