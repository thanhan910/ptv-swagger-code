...
type RouteTypesApiService service
/*
RouteTypesApiService View all route types and their names
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RouteTypesApiRouteTypesGetRouteTypesOpts - Optional Parameters:
...
type RouteTypesApiRouteTypesGetRouteTypesOpts struct {
    Token optional.String
    Devid optional.String
    Signature optional.String
}

func (a *RouteTypesApiService) RouteTypesGetRouteTypes(ctx context.Context, localVarOptionals *RouteTypesApiRouteTypesGetRouteTypesOpts) (V3RouteTypesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue V3RouteTypesResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/route_types"
