...
type PatternsApiService service
/*
PatternsApiService View the stopping pattern for a specific trip/service run
 ...
 * @param optional nil or *PatternsApiPatternsGetPatternByRunOpts - Optional Parameters:
     * @param "StopId" (optional.Int32) -  Filter by stop_id; values returned by Stops API
     * @param "DateUtc" (optional.Time) -  Filter by the date and time of the request (ISO 8601 UTC format)
     * @param "IncludeSkippedStops" (optional.Bool) -  Include any skipped stops in a stopping pattern. Defaults to false.
...
type PatternsApiPatternsGetPatternByRunOpts struct {
    StopId optional.Int32
    DateUtc optional.Time
    IncludeSkippedStops optional.Bool
...
func (a *PatternsApiService) PatternsGetPatternByRun(ctx context.Context, runRef string, routeType int32, expand []string, localVarOptionals *PatternsApiPatternsGetPatternByRunOpts) (V3StoppingPattern, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue V3StoppingPattern
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/pattern/run/{run_ref}/route_type/{route_type}"
	...
	if localVarOptionals != nil && localVarOptionals.StopId.IsSet() {
		localVarQueryParams.Add("stop_id", parameterToString(localVarOptionals.StopId.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.IncludeSkippedStops.IsSet() {
		localVarQueryParams.Add("include_skipped_stops", parameterToString(localVarOptionals.IncludeSkippedStops.Value(), ""))
	}
