...
/**
 * @param outlet_distance Distance of outlet from input location (in metres); returns 0 if no location is input
 ...
 */
case class V3.OutletGeolocation (
  outlet_distance: Option[Float],
