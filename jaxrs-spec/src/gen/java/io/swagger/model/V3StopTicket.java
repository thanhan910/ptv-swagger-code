...
public class V3StopTicket   {
  ...
  private @Valid String ticketType = null;

  private @Valid String zone = null;

  private @Valid Boolean isFreeFareZone = null;

  private @Valid Boolean ticketMachine = null;

  private @Valid Boolean ticketChecks = null;

  private @Valid Boolean vlineReservation = null;

  private @Valid List<Integer> ticketZones = new ArrayList<Integer>();
