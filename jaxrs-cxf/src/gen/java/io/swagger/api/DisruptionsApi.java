...
public interface DisruptionsApi  {
    ...
    @Operation(summary = "View all disruptions for all route types", tags={ "Disruptions" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View a specific disruption", tags={ "Disruptions" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "Get all disruption modes", tags={ "Disruptions" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View all disruptions for a particular route", tags={ "Disruptions" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View all disruptions for a particular route and stop", tags={ "Disruptions" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View all disruptions for a particular stop", tags={ "Disruptions" })
    @ApiResponses(value = { 
