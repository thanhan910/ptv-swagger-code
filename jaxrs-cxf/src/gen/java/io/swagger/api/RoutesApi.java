...
public interface RoutesApi  {
    ...
    @Operation(summary = "View route names and numbers for all routes", tags={ "Routes" })
    @ApiResponses(value = { 
    ...
    public V3RouteResponse routesOneOrMoreRoutes(@QueryParam("route_types") List<Integer> routeTypes, @QueryParam("route_name") String routeName, @QueryParam("token") String token, @QueryParam("devid") String devid, @QueryParam("signature") String signature);
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View route name and number for specific route ID", tags={ "Routes" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public V3RouteResponse routesRouteFromId(@PathParam("route_id") Integer routeId, @QueryParam("include_geopath") Boolean includeGeopath, @QueryParam("geopath_utc") Date geopathUtc, @QueryParam("token") String token, @QueryParam("devid") String devid, @QueryParam("signature") String signature);
}
