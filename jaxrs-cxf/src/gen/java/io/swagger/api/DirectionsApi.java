...
public interface DirectionsApi  {
    ...
    @Operation(summary = "View all routes for a direction of travel", tags={ "Directions" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View all routes of a particular type for a direction of travel", tags={ "Directions" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json", "text/json", "text/html" })
    @Operation(summary = "View directions that a route travels in", tags={ "Directions" })
    @ApiResponses(value = { 
