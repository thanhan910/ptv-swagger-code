...
public interface RouteTypesApi  {
    ...
    @Operation(summary = "View all route types and their names", tags={ "RouteTypes" })
    @ApiResponses(value = { 
    ...
    public V3RouteTypesResponse routeTypesGetRouteTypes(@QueryParam("token") String token, @QueryParam("devid") String devid, @QueryParam("signature") String signature);
}
