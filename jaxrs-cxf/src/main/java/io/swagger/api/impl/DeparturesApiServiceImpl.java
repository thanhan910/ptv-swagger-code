 ...
 *
 */
public class DeparturesApiServiceImpl implements DeparturesApi {
    /**
     * View departures for all routes from a stop
     *
     */
    public V3DeparturesResponse departuresGetForStop(Integer routeType, Integer stopId, List<Integer> platformNumbers, Integer directionId, Boolean gtfs, Date dateUtc, Integer maxResults, Boolean includeCancelled, Boolean lookBackwards, List<String> expand, Boolean includeGeopath, String token, String devid, String signature) {
        // TODO: Implement...
