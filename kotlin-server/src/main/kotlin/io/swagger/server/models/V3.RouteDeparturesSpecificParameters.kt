...
/**
 * 
 * @param trainScheduledTimetables DEPRECATED - use `scheduled_timetables` instead
 * @param scheduledTimetables When set to true, all timetable information returned by Chronos will be sourced from the scheduled timetables,  while when set to false (default state), the operational timetables will be used where available.
 ...
 */
data class V3RouteDeparturesSpecificParameters (

    /* DEPRECATED - use `scheduled_timetables` instead */
    val trainScheduledTimetables: kotlin.Boolean? = null,
    ...
    val expand: kotlin.Array<Expand>? = null,
    /* Indicates if the route geopath should be returned */
    val includeGeopath: kotlin.Boolean? = null
) {
    /**
    * 
    * Values: ALL,STOP,ROUTE,RUN,DIRECTION,DISRUPTION,VEHICLEDESCRIPTOR,VEHICLEPOSITION,NONE
    */
