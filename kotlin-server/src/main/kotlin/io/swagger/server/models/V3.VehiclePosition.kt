 ...
 * @param datetimeUtc Date and time that the vehicle position data was supplied.
 * @param expiryTime CIS - Metro Train Vehicle Location data expiry time
 */
data class V3VehiclePosition (
    ...
    val easting: kotlin.Double? = null,
    /* CIS - Metro Train Vehicle Location Northing coordinate */
    val northing: kotlin.Double? = null,
    ...
    val datetimeUtc: java.time.LocalDateTime? = null,
    /* CIS - Metro Train Vehicle Location data expiry time */
    val expiryTime: java.time.LocalDateTime? = null
) {
}
