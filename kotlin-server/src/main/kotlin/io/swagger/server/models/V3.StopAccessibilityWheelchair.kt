 ...
 * @param lowTicketCounter Indicates if there is at least one low ticket counter at the stop that complies with the Disability Standards for Accessible Public Transport under the Disability Discrimination Act (1992)
 * @param manouvering Indicates if there is a space for mobility device to board on or off a transport mode
 * @param raisedPlatform Indicates if there is a raised platform to board a train
 * @param ramp Indicates if there are ramps (&lt;1:14) at the stop/platform
 * @param secondaryPath Indicates if there is a path beyond the stop which is accessible
 * @param raisedPlatformShelther Indicates if there is shelter near the raised platform
 * @param steepRamp Indicates if there are ramps (&gt;1:14) at the stop/platform
 */
data class V3StopAccessibilityWheelchair (

    val accessibleRamp: kotlin.Boolean? = null,
    ...
    val parking: kotlin.Boolean? = null,
    ...
    val telephone: kotlin.Boolean? = null,
    ...
    val toilet: kotlin.Boolean? = null,
