...
import io.swagger.server.models.V3FareEstimateResponse

@KtorExperimentalLocationsAPI
fun Route.FareEstimateApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()
    get<Paths.fareEstimateGetFareEstimateByZone> {  _: Paths.fareEstimateGetFareEstimateByZone ->
