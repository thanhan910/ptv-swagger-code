...
import io.swagger.server.models.V3DeparturesResponse
import io.swagger.server.models.V3ErrorResponse

@KtorExperimentalLocationsAPI
fun Route.DeparturesApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()
    get<Paths.departuresGetForStop> {  _: Paths.departuresGetForStop ->
  ...
  "status" : {
    ...
    get<Paths.departuresGetForStopAndRoute> {  _: Paths.departuresGetForStopAndRoute ->
        val exampleContentType = "application/json"
        val exampleContentString = """{
  "routes" : {
    "key" : { }
