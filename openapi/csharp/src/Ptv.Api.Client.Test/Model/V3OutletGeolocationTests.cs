...
namespace Ptv.Api.Client.Test.Model
{
    ...
    public class V3OutletGeolocationTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" V3OutletGeolocation
            //Assert.IsType<V3OutletGeolocation>(instance);
        }
