...
namespace Ptv.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "V3.SiriDownstreamSubscriptionDeleteRequest")]
    public partial class V3SiriDownstreamSubscriptionDeleteRequest : IValidatableObject
    {
        /// <summary>
        ...
        public V3SiriDownstreamSubscriptionDeleteRequest(string subscriberRef = default(string), List<string> subscriptionRef = default(List<string>))
        {
            ...
            {
                throw new ArgumentNullException("subscriberRef is a required property for V3SiriDownstreamSubscriptionDeleteRequest and cannot be null");
            }
