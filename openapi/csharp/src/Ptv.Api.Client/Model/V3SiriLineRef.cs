...
namespace Ptv.Api.Client.Model
{
    ...
    /// V3SiriLineRef
    /// </summary>
    [DataContract(Name = "V3.SiriLineRef")]
    public partial class V3SiriLineRef : IValidatableObject
    {
        /// <summary>
        ...
        public V3SiriLineRef(string lineRef = default(string), DirectionRefEnum? directionRef = default(DirectionRefEnum?))
        {
            ...
            if (lineRef == null)
            {
                throw new ArgumentNullException("lineRef is a required property for V3SiriLineRef and cannot be null");
            }
