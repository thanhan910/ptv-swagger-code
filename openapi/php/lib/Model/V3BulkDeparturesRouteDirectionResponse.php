...
/**
 * V3BulkDeparturesRouteDirectionResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class V3BulkDeparturesRouteDirectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.BulkDeparturesRouteDirectionResponse';
    ...
    */
     ...
     * Sets route_id
     *
     * @param string|null $route_id Route identifier
     *
     * @return self
     */
