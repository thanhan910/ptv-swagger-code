 ...
 */
class V3RouteDeparturesSpecificParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3.RouteDeparturesSpecificParameters';
    ...
    protected static array $openAPINullables = [
        'train_scheduled_timetables' => false,
        'scheduled_timetables' => false,
        'date_utc' => false,
        'max_results' => false,
    ...
    {
        $this->setIfExists('train_scheduled_timetables', $data ?? [], null);
        $this->setIfExists('scheduled_timetables', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $train_scheduled_timetables DEPRECATED - use `scheduled_timetables` instead
     *
     * @return self
     */
    public function setTrainScheduledTimetables($train_scheduled_timetables)
    {
        if (is_null($train_scheduled_timetables)) {
            throw new \InvalidArgumentException('non-nullable train_scheduled_timetables cannot be null');
        }
     ...
     *
     * @param bool|null $scheduled_timetables When set to true, all timetable information returned by Chronos will be sourced from the scheduled timetables,  while when set to false (default state), the operational timetables will be used where available.
     *
     * @return self
     */
    public function setScheduledTimetables($scheduled_timetables)
    {
        if (is_null($scheduled_timetables)) {
            throw new \InvalidArgumentException('non-nullable scheduled_timetables cannot be null');
        }
