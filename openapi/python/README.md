...
```sh
pip install git+https://github.com/thanhan910/ptv-api-client-openapi-python.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/thanhan910/ptv-api-client-openapi-python.git`)
