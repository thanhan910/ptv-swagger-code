 ...
 * @param directionId Direction of travel identifier; values returned by Directions API - v3/directions
 * @param directionName Name of direction of travel; values returned by Directions API - v3/directions
 */
data class V3StopDepartureRequestRouteDirection (
    ...
    val directionName: kotlin.String
) {
}