 ...
 * @param taxiRank Indicates if there is a taxi rank at or near the stop
 * @param carParking The number of free car parking spots at the stop
 * @param cctv Indicates if there are CCTV (i.e. closed circuit television) cameras at the stop
 */
data class V3StopAmenityDetails (
