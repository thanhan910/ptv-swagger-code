 ...
 */
case class PatternDeparture (
  skippedStops: Option[List[V3.StopModel]] = None,
  ...
  scheduledDepartureUtc: Option[Date] = None,
  estimatedDepartureUtc: Option[Date] = None,
  atPlatform: Option[Boolean] = None,
  platformNumber: Option[String] = None,
  flags: Option[String] = None,
  departureSequence: Option[Integer] = None
)
