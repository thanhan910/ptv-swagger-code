 ...
 * @param wheelchair 
 */
case class StopAccessibility (
  lighting: Option[Boolean] = None,
  platformNumber: Option[Integer] = None,
  audioCustomerInformation: Option[Boolean] = None,
  escalator: Option[Boolean] = None,
  hearingLoop: Option[Boolean] = None,
  lift: Option[Boolean] = None,
  stairs: Option[Boolean] = None,
  stopAccessible: Option[Boolean] = None,
  tactileGroundSurfaceIndicator: Option[Boolean] = None,
  waitingRoom: Option[Boolean] = None,
  wheelchair: Option[V3.StopAccessibilityWheelchair] = None
)
