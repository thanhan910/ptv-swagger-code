 ...
 * @param status 
 */
case class BulkDeparturesResponse (
  responses: Option[List[V3.BulkDeparturesUpdateResponse]] = None,
  stops: Option[Map[String, V3.BulkDeparturesStopResponse]] = None,
  routes: Option[List[Any]] = None,
  runs: Option[List[V3.Run]] = None,
  directions: Option[List[V3.Direction]] = None,
  disruptions: Option[Map[String, V3.Disruption]] = None,
  status: Option[V3.Status] = None
)
