 ...
 */
case class OutletGeolocation (
  outletDistance: Option[Float] = None,
  outletSlidSpid: Option[String] = None,
  outletName: Option[String] = None,
  outletBusiness: Option[String] = None,
  outletLatitude: Option[Float] = None,
  outletLongitude: Option[Float] = None,
  outletSuburb: Option[String] = None,
  outletPostcode: Option[Integer] = None,
  outletBusinessHourMon: Option[String] = None,
  outletBusinessHourTue: Option[String] = None,
  outletBusinessHourWed: Option[String] = None,
  outletBusinessHourThur: Option[String] = None,
  outletBusinessHourFri: Option[String] = None,
  outletBusinessHourSat: Option[String] = None,
  outletBusinessHourSun: Option[String] = None,
  outletNotes: Option[String] = None
)
