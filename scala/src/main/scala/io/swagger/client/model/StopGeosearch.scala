 ...
 */
case class StopGeosearch (
  disruptionIds: Option[List[Long]] = None,
  stopDistance: Option[Float] = None,
  stopSuburb: Option[String] = None,
  stopName: Option[String] = None,
  stopId: Option[Integer] = None,
  routeType: Option[Integer] = None,
  routes: Option[List[Any]] = None,
  stopLatitude: Option[Float] = None,
  stopLongitude: Option[Float] = None,
  stopLandmark: Option[String] = None,
  stopSequence: Option[Integer] = None
)
