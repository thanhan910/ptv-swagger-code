 ...
 * @param status 
 */
case class StoppingPattern (
  disruptions: Option[List[V3.Disruption]] = None,
  departures: Option[List[V3.PatternDeparture]] = None,
  stops: Option[Map[String, V3.StoppingPatternStop]] = None,
  routes: Option[Map[String, Any]] = None,
  runs: Option[Map[String, V3.Run]] = None,
  directions: Option[Map[String, V3.Direction]] = None,
