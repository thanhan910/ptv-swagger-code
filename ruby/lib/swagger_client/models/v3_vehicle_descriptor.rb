  ...
  class V3VehicleDescriptor
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::V3VehicleDescriptor` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::V3VehicleDescriptor`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'low_floor')
        self.low_floor = attributes[:'low_floor']
      end

      if attributes.key?(:'air_conditioned')
        self.air_conditioned = attributes[:'air_conditioned']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          operator == o.operator &&
          id == o.id &&
          low_floor == o.low_floor &&
          air_conditioned == o.air_conditioned &&
    ...
    def hash
      [operator, id, low_floor, air_conditioned, description, supplier, length].hash
    end
