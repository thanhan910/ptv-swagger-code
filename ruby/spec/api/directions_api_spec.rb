...
# Unit tests for SwaggerClient::DirectionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectionsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectionsApi.new
  end
  ...
  describe 'test an instance of DirectionsApi' do
    it 'should create an instance of DirectionsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectionsApi)
    end
  end

  # unit tests for directions_for_direction
  ...
  describe 'directions_for_direction test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for directions_for_direction_and_type
  ...
  # @option opts [String] :signature Authentication signature for request
  # @return [V3DirectionsResponse]
  describe 'directions_for_direction_and_type test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for directions_for_route
  ...
  # @option opts [String] :signature Authentication signature for request
  # @return [V3DirectionsResponse]
  describe 'directions_for_route test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
