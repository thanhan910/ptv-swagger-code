...
# Unit tests for SwaggerClient::FareEstimateApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FareEstimateApi' do
  before do
    # run before each test
    @instance = SwaggerClient::FareEstimateApi.new
  end
  ...
  describe 'test an instance of FareEstimateApi' do
    it 'should create an instance of FareEstimateApi' do
      expect(@instance).to be_instance_of(SwaggerClient::FareEstimateApi)
    end
  end

  # unit tests for fare_estimate_get_fare_estimate_by_zone
  ...
  describe 'fare_estimate_get_fare_estimate_by_zone test' do
    it 'should work' do
