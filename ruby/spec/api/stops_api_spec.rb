...
# Unit tests for SwaggerClient::StopsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StopsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::StopsApi.new
  end
  ...
  describe 'test an instance of StopsApi' do
    it 'should create an instance of StopsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::StopsApi)
    end
  end

  # unit tests for stops_stop_details
  ...
  describe 'stops_stop_details test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for stops_stops_by_geolocation
  ...
  describe 'stops_stops_by_geolocation test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for stops_stops_for_route
  ...
  describe 'stops_stops_for_route test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
