...
public class V3BulkDeparturesResponse   {
  private List<V3BulkDeparturesUpdateResponse> responses = new ArrayList<V3BulkDeparturesUpdateResponse>();
  private Map<String, V3BulkDeparturesStopResponse> stops = new HashMap<String, V3BulkDeparturesStopResponse>();
  private List<Object> routes = new ArrayList<Object>();
  private List<V3Run> runs = new ArrayList<V3Run>();
  private List<V3Direction> directions = new ArrayList<V3Direction>();
