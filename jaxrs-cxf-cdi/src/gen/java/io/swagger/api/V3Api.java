...
public class V3Api  {
  ...
  @Inject V3ApiService delegate;
    ...
    public Response departuresGetForStop(
@Parameter(description = "Number identifying transport mode; values returned via RouteTypes API",required=true, schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
) @PathParam("route_type") Integer routeType
, 
@Parameter(description = "Identifier of stop; values returned by Stops API",required=true) @PathParam("stop_id") Integer stopId
,  
@Parameter(description = "Filter by platform number at stop")  @QueryParam("platform_numbers") List<Integer> platformNumbers
,  
@Parameter(description = "Filter by identifier of direction of travel; values returned by Directions API - /v3/directions/route/{route_id}")  @QueryParam("direction_id") Integer directionId
,  
@Parameter(description = "Indicates that stop_id parameter will accept \"GTFS stop_id\" data")  @QueryParam("gtfs") Boolean gtfs
,  
@Parameter(description = "Filter by the date and time of the request (ISO 8601 UTC format) (default = current date and time)")  @QueryParam("date_utc") java.util.Date dateUtc
,  
@Parameter(description = "Maximum number of results returned")  @QueryParam("max_results") Integer maxResults
,  
@Parameter(description = "Indicates if cancelled services (if they exist) are returned (default = false) - metropolitan train only")  @QueryParam("include_cancelled") Boolean includeCancelled
,  
@Parameter(description = "Indicates if filtering runs (and their departures) to those that arrive at destination before date_utc (default = false). Requires max_results &gt; 0.")  @QueryParam("look_backwards") Boolean lookBackwards
,  
@Parameter(description = "List of objects to be returned in full (i.e. expanded) - options include: All, Stop, Route, Run, Direction, Disruption, VehiclePosition, VehicleDescriptor or None.  Run must be expanded to receive VehiclePosition and VehicleDescriptor information.", schema=@Schema(allowableValues={ "All", "Stop", "Route", "Run", "Direction", "Disruption", "VehicleDescriptor", "VehiclePosition", "None" })
)  @QueryParam("expand") List<String> expand
,  
@Parameter(description = "Indicates if the route geopath should be returned")  @QueryParam("include_geopath") Boolean includeGeopath
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
,  
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
) {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response departuresGetForStopAndRoute(
@Parameter(description = "Number identifying transport mode; values returned via RouteTypes API",required=true, schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
) @PathParam("route_type") Integer routeType
, 
@Parameter(description = "Identifier of stop; values returned by Stops API",required=true) @PathParam("stop_id") Integer stopId
, 
@Parameter(description = "Identifier of route; values returned by Routes API - v3/routes",required=true) @PathParam("route_id") String routeId
,  
@Parameter(description = "Filter by identifier of direction of travel; values returned by Directions API - /v3/directions/route/{route_id}")  @QueryParam("direction_id") Integer directionId
,  
@Parameter(description = "Indicates that stop_id parameter will accept \"GTFS stop_id\" data")  @QueryParam("gtfs") Boolean gtfs
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response directionsForDirection(
@Parameter(description = "Identifier of direction of travel; values returned by Directions API - /v3/directions/route/{route_id}",required=true) @PathParam("direction_id") Integer directionId
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response directionsForDirectionAndType(
@Parameter(description = "Identifier of direction of travel; values returned by Directions API - /v3/directions/route/{route_id}",required=true) @PathParam("direction_id") Integer directionId
, 
@Parameter(description = "Number identifying transport mode; values returned via RouteTypes API",required=true, schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
) @PathParam("route_type") Integer routeType
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response directionsForRoute(
@Parameter(description = "Identifier of route; values returned by Routes API - v3/routes",required=true) @PathParam("route_id") Integer routeId
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response disruptionsGetAllDisruptions( 
@Parameter(description = "Filter by route_type; values returned via RouteTypes API", schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
)  @QueryParam("route_types") List<Integer> routeTypes
,  
@Parameter(description = "Filter by disruption_mode; values returned via v3/disruptions/modes API", schema=@Schema(allowableValues={ "1", "2", "3", "4", "5", "7", "8", "9", "10", "11", "12", "13", "14", "100" })
)  @QueryParam("disruption_modes") List<Integer> disruptionModes
,  
@Parameter(description = "Filter by status of disruption", schema=@Schema(allowableValues={ "current", "planned" })
)  @QueryParam("disruption_status") String disruptionStatus
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response disruptionsGetDisruptionById(
@Parameter(description = "Identifier of disruption; values returned by Disruptions API - /v3/disruptions OR /v3/disruptions/route/{route_id}",required=true) @PathParam("disruption_id") Long disruptionId
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response disruptionsGetDisruptionModes( 
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
,  
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response disruptionsGetDisruptionsByRouteAndStop(
@Parameter(description = "Identifier of route; values returned by Routes API - v3/routes",required=true) @PathParam("route_id") Integer routeId
, 
@Parameter(description = "Identifier of stop; values returned by Stops API - v3/stops",required=true) @PathParam("stop_id") Integer stopId
,  
@Parameter(description = "Filter by status of disruption", schema=@Schema(allowableValues={ "current", "planned" })
)  @QueryParam("disruption_status") String disruptionStatus
,  
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response disruptionsGetDisruptionsByStop(
@Parameter(description = "Identifier of stop; values returned by Stops API - v3/stops",required=true) @PathParam("stop_id") Integer stopId
,  
@Parameter(description = "Filter by status of disruption", schema=@Schema(allowableValues={ "current", "planned" })
)  @QueryParam("disruption_status") String disruptionStatus
...
@Parameter(description = "Minimum Zone travelled through ie. 1",required=true) @PathParam("minZone") Integer minZone
, 
@Parameter(description = "Maximum Zone travelled through id. 6",required=true) @PathParam("maxZone") Integer maxZone
,  
@Parameter(description = "JourneyTouchOnUtc in format yyyy-M-d h:m (e.g 2016-5-31 16:53).")  @QueryParam("journey_touch_on_utc") java.util.Date journeyTouchOnUtc
,  
@Parameter(description = "JourneyTouchOffUtc in format yyyy-M-d h:m (e.g 2016-5-31 16:53).")  @QueryParam("journey_touch_off_utc") java.util.Date journeyTouchOffUtc
,  
@Parameter(description = "")  @QueryParam("is_journey_in_free_tram_zone") Boolean isJourneyInFreeTramZone
,  
@Parameter(description = "", schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
)  @QueryParam("travelled_route_types") List<Integer> travelledRouteTypes
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response outletsGetAllOutlets( 
@Parameter(description = "Maximum number of results returned (default = 30)")  @QueryParam("max_results") Integer maxResults
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response outletsGetOutletsByGeolocation(
@Parameter(description = "Geographic coordinate of latitude",required=true) @PathParam("latitude") Float latitude
, 
@Parameter(description = "Geographic coordinate of longitude",required=true) @PathParam("longitude") Float longitude
,  
@Parameter(description = "Filter by maximum distance (in metres) from location specified via latitude and longitude parameters (default = 300)")  @QueryParam("max_distance") Double maxDistance
,  
@Parameter(description = "Maximum number of results returned (default = 30)")  @QueryParam("max_results") Integer maxResults
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response patternsGetPatternByRun(
@Parameter(description = "The run_ref is the identifier of a run as returned by the departures/_* and runs/_* endpoints. WARNING, run_id is deprecated. Use run_ref instead.",required=true) @PathParam("run_ref") String runRef
, 
@Parameter(description = "Number identifying transport mode; values returned via RouteTypes API",required=true, schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
) @PathParam("route_type") Integer routeType
,  @NotNull 
@Parameter(description = "List of objects to be returned in full (i.e. expanded) - options include: All, Stop, Route, Run, Direction, Disruption, VehiclePosition, VehicleDescriptor and None. Default is Disruption. Run must be expanded to receive VehiclePosition and VehicleDescriptor information.",required=true, schema=@Schema(allowableValues={ "All", "Stop", "Route", "Run", "Direction", "Disruption", "VehicleDescriptor", "VehiclePosition", "None" })
)  @QueryParam("expand") List<String> expand
,  
@Parameter(description = "Filter by stop_id; values returned by Stops API")  @QueryParam("stop_id") Integer stopId
,  
@Parameter(description = "Filter by the date and time of the request (ISO 8601 UTC format)")  @QueryParam("date_utc") java.util.Date dateUtc
,  
@Parameter(description = "Include any skipped stops in a stopping pattern. Defaults to false.")  @QueryParam("include_skipped_stops") Boolean includeSkippedStops
,  
@Parameter(description = "Indicates if geopath data will be returned (default = false)")  @QueryParam("include_geopath") Boolean includeGeopath
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response routeTypesGetRouteTypes( 
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
,  
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response routesOneOrMoreRoutes( 
@Parameter(description = "Filter by route_type; values returned via RouteTypes API", schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
)  @QueryParam("route_types") List<Integer> routeTypes
,  
@Parameter(description = "Filter by name  of route (accepts partial route name matches)")  @QueryParam("route_name") String routeName
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response routesRouteFromId(
@Parameter(description = "Identifier of route; values returned by Departures, Directions and Disruptions APIs",required=true) @PathParam("route_id") Integer routeId
,  
@Parameter(description = "Indicates kif geopath data will be returned (default = false)")  @QueryParam("include_geopath") Boolean includeGeopath
,  
@Parameter(description = "Filter geopaths by date (ISO 8601 UTC format) (default = current date)")  @QueryParam("geopath_utc") java.util.Date geopathUtc
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response runsForRoute(
@Parameter(description = "Identifier of route; values returned by Routes API - v3/routes.",required=true) @PathParam("route_id") Integer routeId
,  
@Parameter(description = "List of objects to be returned in full (i.e. expanded) - options include: All, VehiclePosition, VehicleDescriptor, or None. Default is None.", schema=@Schema(allowableValues={ "All", "VehicleDescriptor", "VehiclePosition", "None" })
)  @QueryParam("expand") List<String> expand
,  
@Parameter(description = "Date of the request. (optional - defaults to now)")  @QueryParam("date_utc") java.util.Date dateUtc
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response runsForRouteAndRouteType(
@Parameter(description = "Identifier of route; values returned by Routes API - v3/routes.",required=true) @PathParam("route_id") Integer routeId
, 
@Parameter(description = "Number identifying transport mode; values returned via RouteTypes API",required=true, schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
) @PathParam("route_type") Integer routeType
,  @NotNull 
@Parameter(description = "List of objects to be returned in full (i.e. expanded) - options include: All, VehiclePosition, VehicleDescriptor, or None. Default is All.",required=true, schema=@Schema(allowableValues={ "All", "VehicleDescriptor", "VehiclePosition", "None" })
)  @QueryParam("expand") List<String> expand
,  
@Parameter(description = "Date of the request. (optional - defaults to now)")  @QueryParam("date_utc") java.util.Date dateUtc
,  
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response runsForRun(
@Parameter(description = "The run_ref is the identifier of a run as returned by the departures/_* and runs/_* endpoints. WARNING, run_id is deprecated. Use run_ref instead.",required=true) @PathParam("run_ref") String runRef
,  @NotNull 
@Parameter(description = "List of objects to be returned in full (i.e. expanded) - options include: All, VehiclePosition, VehicleDescriptor, or None. Default is None.",required=true, schema=@Schema(allowableValues={ "All", "VehicleDescriptor", "VehiclePosition", "None" })
)  @QueryParam("expand") List<String> expand
,  
@Parameter(description = "Date of the request. (optional - defaults to now)")  @QueryParam("date_utc") java.util.Date dateUtc
,  
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response runsForRunAndRouteType(
@Parameter(description = "The run_ref is the identifier of a run as returned by the departures/_* and runs/_* endpoints. WARNING, run_id is deprecated. Use run_ref instead.",required=true) @PathParam("run_ref") String runRef
, 
@Parameter(description = "Number identifying transport mode; values returned via RouteTypes API",required=true, schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
) @PathParam("route_type") Integer routeType
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response searchSearch(
@Parameter(description = "Search text (note: if search text is numeric and/or less than 3 characters, the API will only return routes)",required=true) @PathParam("search_term") String searchTerm
,  
@Parameter(description = "Filter by route_type; values returned via RouteTypes API (note: stops and routes are ordered by route_types specified)", schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
)  @QueryParam("route_types") List<Integer> routeTypes
,  
@Parameter(description = "Filter by geographic coordinate of latitude")  @QueryParam("latitude") Float latitude
,  
@Parameter(description = "Filter by geographic coordinate of longitude")  @QueryParam("longitude") Float longitude
,  
@Parameter(description = "Filter by maximum distance (in metres) from location specified via latitude and longitude parameters")  @QueryParam("max_distance") Float maxDistance
,  
@Parameter(description = "Placeholder for future development; currently unavailable")  @QueryParam("include_addresses") Boolean includeAddresses
,  
@Parameter(description = "Indicates if outlets will be returned in response (default = true)")  @QueryParam("include_outlets") Boolean includeOutlets
,  
@Parameter(description = "Indicates whether to find stops by suburbs in the search term (default = true)")  @QueryParam("match_stop_by_suburb") Boolean matchStopBySuburb
,  
@Parameter(description = "Indicates whether to find routes by suburbs in the search term (default = true)")  @QueryParam("match_route_by_suburb") Boolean matchRouteBySuburb
,  
@Parameter(description = "Indicates whether to search for stops according to a metlink stop ID (default = false)")  @QueryParam("match_stop_by_gtfs_stop_id") Boolean matchStopByGtfsStopId
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response stopsStopDetails(
@Parameter(description = "Identifier of stop; values returned by Stops API",required=true) @PathParam("stop_id") Integer stopId
, 
@Parameter(description = "Number identifying transport mode; values returned via RouteTypes API",required=true, schema=@Schema(allowableValues={ "0", "1", "2", "3", "4" })
) @PathParam("route_type") Integer routeType
,  
@Parameter(description = "Indicates if stop location information will be returned (default = false)")  @QueryParam("stop_location") Boolean stopLocation
,  
@Parameter(description = "Indicates if stop amenity information will be returned (default = false)")  @QueryParam("stop_amenities") Boolean stopAmenities
,  
@Parameter(description = "Indicates if stop accessibility information will be returned (default = false)")  @QueryParam("stop_accessibility") Boolean stopAccessibility
,  
@Parameter(description = "Indicates if stop contact information will be returned (default = false)")  @QueryParam("stop_contact") Boolean stopContact
,  
@Parameter(description = "Indicates if stop ticket information will be returned (default = false)")  @QueryParam("stop_ticket") Boolean stopTicket
,  
@Parameter(description = "Incdicates whether the stop_id is a GTFS ID or not")  @QueryParam("gtfs") Boolean gtfs
,  
@Parameter(description = "Indicates if stop staffing information will be returned (default = false)")  @QueryParam("stop_staffing") Boolean stopStaffing
,  
@Parameter(description = "Indicates if stop disruption information will be returned (default = false)")  @QueryParam("stop_disruptions") Boolean stopDisruptions
,  
@Parameter(description = "Please ignore")  @QueryParam("token") String token
,  
@Parameter(description = "Your developer id")  @QueryParam("devid") String devid
...
@Parameter(description = "Authentication signature for request")  @QueryParam("signature") String signature
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))),
        @ApiResponse(responseCode = "403", description = "Access Denied", content = @Content(mediaType = "application/json", schema = @Schema(implementation = V3ErrorResponse.class))) })
    public Response stopsStopsByGeolocation(
@Parameter(description = "Geographic coordinate of latitude",required=true) @PathParam("latitude") Float latitude
, 
@Parameter(description = "Geographic coordinate of longitude",required=true) @PathParam("longitude") Float longitude
,  
...
,  
@Parameter(description = "An optional direction; values returned by Directions API. When this is set, stop sequence information is returned in the response.")  @QueryParam("direction_id") Integer directionId
,  
@Parameter(description = "Indicates if stop disruption information will be returned (default = false)")  @QueryParam("stop_disruptions") Boolean stopDisruptions
,  
@Parameter(description = "Indicates if geopath data will be returned (default = false)")  @QueryParam("include_geopath") Boolean includeGeopath
